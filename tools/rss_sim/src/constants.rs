...
pub const LCDA_SPEED_FRAC_EXP: f64 = 0.58;
pub const LCDA_SPEED_QUARTIC_COEFF: f64 = 0.27;
pub const LCDA_LOAD_COEFF: f64 = 1.96;
pub const LCDA_LOAD_EXP: f64 = 1.36;
pub const LCDA_GRADE_COEFF: f64 = 34.0;
pub const LCDA_GRADE_BASE_A: f64 = 1.05;
pub const LCDA_GRADE_BASE_B: f64 = 1.1;
pub const LCDA_GRADE_OFFSET: f64 = 32.0;
pub const LCDA_MAX_SPEED_MS: f64 = 1.97;
pub const V6_INVERT_SPEED_MAX_MS: f64 = 6.0;
pub const V6_CRITICAL_POWER_WATTS_DEFAULT: f64 = 780.0;
pub const V6_W_PRIME_MAX_JOULES_DEFAULT: f64 = 20_000.0;
pub const V6_W_PRIME_RECOVERY_W_PER_S_DEFAULT: f64 = 12.0;
pub const V6_SPRINT_POWER_CAP_WATTS_DEFAULT: f64 = 2400.0;
pub const V6_STAMINA_DRAIN_CALIBRATION: f64 = 0.72;
pub const LOADED_RUN_DRAIN_START_KG: f64 = 12.0;
pub const LOADED_RUN_DRAIN_REF_KG: f64 = 30.0;
pub const LOADED_RUN_DRAIN_MAX_MULT: f64 = 4.5;
...
pub const V5_SPRINT_SPEED_MS_DEFAULT: f64 = 4.5;
pub const SPRINT_GAIT_MIN_OVER_RUN_RATIO: f64 = 1.25;
pub const SPRINT_ENCUMBRANCE_PENALTY_MULT: f64 = 2.2;
