...
**文件位置**: [SCR_EnvironmentFactor.c#L327-L388](f\scripts\Game\Components\Stamina\SCR_EnvironmentFactor.c#L327-L388)
...
| `EXHAUSTION_LIMP_SPEED` | 1.0 m/s | 跛行速度 | [SCR_StaminaConstants.c#L45](f\scripts\Game\Components\Stamina\SCR_StaminaConstants.c#L45) |
...
| 常量名 | 数值 | 说明 | 文件位置 |
|--------|------|------|----------|
| `SPRINT_BASE_DRAIN_RATE` | 0.480 pts/s | Sprint基础消耗率 | [SCR_StaminaConstants.c#L27](f\scripts\Game\Components\Stamina\SCR_StaminaConstants.c#L27) |
| `RUN_BASE_DRAIN_RATE` | 0.075 pts/s | Run基础消耗率 | [SCR_StaminaConstants.c#L28](f\scripts\Game\Components\Stamina\SCR_StaminaConstants.c#L28) |
| `WALK_BASE_DRAIN_RATE` | 0.045 pts/s | Walk基础消耗率 | [SCR_StaminaConstants.c#L29](f\scripts\Game\Components\Stamina\SCR_StaminaConstants.c#L29) |
