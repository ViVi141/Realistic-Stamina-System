...
| `GIVONI_CONSTANT` | 0.6 | Givoni-Goldman跑步常数 (W/kg·m²/s²) | [rss_digital_twin_fix.py#L35](f\tools\rss_digital_twin_fix.py#L35) |
| `GIVONI_VELOCITY_EXPONENT` | 2.2 | Givoni-Goldman速度指数 | [rss_digital_twin_fix.py#L36](f\tools\rss_digital_twin_fix.py#L36) |
