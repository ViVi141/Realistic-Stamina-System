...
- **GUID**: `68649101601CC93D` · **Config**: **6.1.5** · **Game**: Reforger **1.7+**
...
完整逐条记录：[CHANGELOG.md](CHANGELOG.md) **[6.1.5]**、**[6.1.4]**、**[6.1.3]**、**[6.1.2]**、**[6.1.1]**、**[6.1.0]**、**[6.0.0]**、**[5.0.0]**、**[3.23.1]**。机制清单见上文「数学模型 / 机制与特性」。
