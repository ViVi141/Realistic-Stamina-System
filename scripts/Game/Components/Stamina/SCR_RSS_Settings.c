...
protected void InitEliteStandardDefaults(bool shouldInit)
{
	...
	m_EliteStandard.energy_to_stamina_coeff = 5.1912973592251333e-07;
	m_EliteStandard.base_recovery_rate = 6.8299611053368011e-05;
	m_EliteStandard.standing_recovery_multiplier = 1.0312051366102546;
	m_EliteStandard.prone_recovery_multiplier = 2.477027279991506;
	m_EliteStandard.load_recovery_penalty_coeff = 1.6965281867192795e-05;
	m_EliteStandard.load_recovery_penalty_exponent = 1.8226534590503691;
	m_EliteStandard.encumbrance_speed_penalty_coeff = 0.13416983551111455;
	m_EliteStandard.encumbrance_speed_penalty_exponent = 1.5;
	m_EliteStandard.encumbrance_speed_penalty_max = 0.6497173125105724;
	m_EliteStandard.encumbrance_stamina_drain_coeff = 1.0229816053816994;
	m_EliteStandard.load_metabolic_dampening = 0.58355845587691;
	m_EliteStandard.max_recovery_per_tick = 5.6821435404102181e-04;
	m_EliteStandard.sprint_stamina_drain_multiplier = 3.5;
	m_EliteStandard.fatigue_accumulation_coeff = 0.008878391566182519;
	m_EliteStandard.fatigue_max_factor = 2.5376664587129736;
	m_EliteStandard.aerobic_efficiency_factor = 0.9;
	m_EliteStandard.anaerobic_efficiency_factor = 1.2;
	m_EliteStandard.recovery_nonlinear_coeff = 0.3069772508555393;
	m_EliteStandard.fast_recovery_multiplier = 4.131168568854321;
	m_EliteStandard.medium_recovery_multiplier = 1.9520432555319958;
	m_EliteStandard.slow_recovery_multiplier = 0.5314411968618767;
	m_EliteStandard.marginal_decay_threshold = 0.8057313207978551;
	m_EliteStandard.marginal_decay_coeff = 1.1298555838130597;
	...
	m_EliteStandard.swimming_encumbrance_threshold = 27.621296204503246;
	m_EliteStandard.swimming_static_drain_multiplier = 3.058171183890441;
	m_EliteStandard.swimming_dynamic_power_efficiency = 1.8470023354122;
	m_EliteStandard.swimming_energy_to_stamina_coeff = 4.6951598087150008e-05;
	m_EliteStandard.env_heat_stress_max_multiplier = 1.5498974598626265;
	m_EliteStandard.env_rain_weight_max = 8.009487279888383;
	m_EliteStandard.env_wind_resistance_coeff = 0.06979399228247171;
...
protected void InitStandardMilsimDefaults(bool shouldInit)
{
	...
	m_StandardMilsim.energy_to_stamina_coeff = 9.7640979101523254e-07;
	m_StandardMilsim.base_recovery_rate = 8.6388705875844158e-05;
	m_StandardMilsim.standing_recovery_multiplier = 1.6372336528237166;
	m_StandardMilsim.prone_recovery_multiplier = 2.559881173860466;
	m_StandardMilsim.load_recovery_penalty_coeff = 1.0740519615054227e-04;
	m_StandardMilsim.load_recovery_penalty_exponent = 1.4605091599081788;
	m_StandardMilsim.encumbrance_speed_penalty_coeff = 0.15213104510806985;
	m_StandardMilsim.encumbrance_speed_penalty_exponent = 1.5;
	m_StandardMilsim.encumbrance_speed_penalty_max = 0.5347087736757811;
	m_StandardMilsim.encumbrance_stamina_drain_coeff = 0.9308209668864964;
	m_StandardMilsim.load_metabolic_dampening = 0.7999325454542858;
	m_StandardMilsim.max_recovery_per_tick = 4.7368363007539466e-04;
	m_StandardMilsim.sprint_stamina_drain_multiplier = 3.5;
	m_StandardMilsim.fatigue_accumulation_coeff = 0.005547172698130212;
	m_StandardMilsim.fatigue_max_factor = 2.7707361855046617;
	m_StandardMilsim.aerobic_efficiency_factor = 0.9;
	m_StandardMilsim.anaerobic_efficiency_factor = 1.2;
	m_StandardMilsim.recovery_nonlinear_coeff = 0.3837520701170676;
	m_StandardMilsim.fast_recovery_multiplier = 2.972166254563734;
	m_StandardMilsim.medium_recovery_multiplier = 1.6014770199362054;
	m_StandardMilsim.slow_recovery_multiplier = 0.6394865070853192;
	m_StandardMilsim.marginal_decay_threshold = 0.728695140826843;
	m_StandardMilsim.marginal_decay_coeff = 1.1007802884798514;
	m_StandardMilsim.min_recovery_stamina_threshold = 0.24067894038860252;
	m_StandardMilsim.min_recovery_rest_time_seconds = 8.188828232404248;
	m_StandardMilsim.sprint_speed_boost = 0.29726595127913447;
	m_StandardMilsim.sprint_velocity_threshold = 5.5;
	m_StandardMilsim.posture_crouch_multiplier = 1.8448773204888744;
	m_StandardMilsim.posture_prone_multiplier = 2.475087411972421;
	m_StandardMilsim.jump_efficiency = 0.22;
	m_StandardMilsim.jump_height_guess = 0.8240100086982618;
	m_StandardMilsim.jump_horizontal_speed_guess = 0.23719896857904688;
	...
	m_StandardMilsim.swimming_base_power = 16.506002734275928;
	m_StandardMilsim.swimming_encumbrance_threshold = 29.416053369059945;
	m_StandardMilsim.swimming_static_drain_multiplier = 3.1209664277671587;
	m_StandardMilsim.swimming_dynamic_power_efficiency = 1.9361265291353167;
	m_StandardMilsim.swimming_energy_to_stamina_coeff = 4.3903876285518516e-05;
	m_StandardMilsim.env_heat_stress_max_multiplier = 1.5388284550764548;
	m_StandardMilsim.env_rain_weight_max = 6.986427054720942;
	m_StandardMilsim.env_wind_resistance_coeff = 0.03625267882835444;
	m_StandardMilsim.env_mud_penalty_max = 0.4478825778795923;
	m_StandardMilsim.env_temperature_heat_penalty_coeff = 0.022810307043339192;
	m_StandardMilsim.env_temperature_cold_recovery_penalty_coeff = 0.04794870544774151;
...
protected void InitTacticalActionDefaults(bool shouldInit)
{
	...
	m_TacticalAction.energy_to_stamina_coeff = 5.1263429369435458e-07;
	m_TacticalAction.base_recovery_rate = 6.6562955662791704e-05;
	m_TacticalAction.standing_recovery_multiplier = 1.255450910072332;
	m_TacticalAction.prone_recovery_multiplier = 3.3577796533110353;
	m_TacticalAction.load_recovery_penalty_coeff = 6.9828424309945872e-05;
	m_TacticalAction.load_recovery_penalty_exponent = 1.6900468884094497;
	m_TacticalAction.encumbrance_speed_penalty_coeff = 0.11896607869281824;
	m_TacticalAction.encumbrance_speed_penalty_exponent = 1.5;
	m_TacticalAction.encumbrance_speed_penalty_max = 0.5895511636509397;
	m_TacticalAction.encumbrance_stamina_drain_coeff = 1.158756417582656;
	m_TacticalAction.load_metabolic_dampening = 0.6386981813837799;
	m_TacticalAction.max_recovery_per_tick = 4.7610504367416042e-04;
	m_TacticalAction.sprint_stamina_drain_multiplier = 3.5;
	m_TacticalAction.fatigue_accumulation_coeff = 0.010272789664973341;
	m_TacticalAction.fatigue_max_factor = 2.333240244697488;
	m_TacticalAction.aerobic_efficiency_factor = 0.9;
	m_TacticalAction.anaerobic_efficiency_factor = 1.2;
	m_TacticalAction.recovery_nonlinear_coeff = 0.503511073646223;
	m_TacticalAction.fast_recovery_multiplier = 3.2476951587010787;
	m_TacticalAction.medium_recovery_multiplier = 1.1867268984993682;
	m_TacticalAction.slow_recovery_multiplier = 0.725712358831304;
	m_TacticalAction.marginal_decay_threshold = 0.782029943977728;
	m_TacticalAction.marginal_decay_coeff = 1.050604704318398;
	m_TacticalAction.min_recovery_stamina_threshold = 0.16454161500926148;
	m_TacticalAction.min_recovery_rest_time_seconds = 15.99057764647471;
	m_TacticalAction.sprint_speed_boost = 0.3015375362634564;
	m_TacticalAction.sprint_velocity_threshold = 5.5;
	m_TacticalAction.posture_crouch_multiplier = 1.8447986451638665;
	m_TacticalAction.posture_prone_multiplier = 2.103665734343938;
	m_TacticalAction.jump_efficiency = 0.22;
	m_TacticalAction.jump_height_guess = 0.3819469114993241;
	m_TacticalAction.jump_horizontal_speed_guess = 0.30869156548413257;
	...
	m_TacticalAction.swimming_base_power = 22.61510631717472;
	m_TacticalAction.swimming_encumbrance_threshold = 25.46677264897312;
	m_TacticalAction.swimming_static_drain_multiplier = 3.3844787275967594;
	m_TacticalAction.swimming_dynamic_power_efficiency = 1.6906685810211732;
	m_TacticalAction.swimming_energy_to_stamina_coeff = 5.6353986236952125e-05;
	m_TacticalAction.env_heat_stress_max_multiplier = 1.2291052025456775;
	m_TacticalAction.env_rain_weight_max = 6.664917448206635;
	m_TacticalAction.env_wind_resistance_coeff = 0.05640468384500616;
	m_TacticalAction.env_mud_penalty_max = 0.42619823084272845;
	m_TacticalAction.env_temperature_heat_penalty_coeff = 0.015848377140851917;
	m_TacticalAction.env_temperature_cold_recovery_penalty_coeff = 0.04836405568685448;
