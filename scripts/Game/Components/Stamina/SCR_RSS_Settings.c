...
protected void InitEliteStandardDefaults(bool shouldInit)
{
	...
	m_EliteStandard.energy_to_stamina_coeff = 6.6840703287637927e-07;
	m_EliteStandard.base_recovery_rate = 3.8360202103360095e-04;
	m_EliteStandard.standing_recovery_multiplier = 1.420137453587221;
	m_EliteStandard.prone_recovery_multiplier = 3.2952974507206623;
	m_EliteStandard.load_recovery_penalty_coeff = 2.1524245152256242e-05;
	m_EliteStandard.load_recovery_penalty_exponent = 1.8652295958604461;
	m_EliteStandard.encumbrance_speed_penalty_coeff = 0.15402713270272494;
	m_EliteStandard.encumbrance_speed_penalty_exponent = 1.5;
	m_EliteStandard.encumbrance_speed_penalty_max = 0.5543056483458749;
	m_EliteStandard.encumbrance_stamina_drain_coeff = 0.819961507574174;
	m_EliteStandard.fatigue_accumulation_coeff = 0.005615296613635597;
	m_EliteStandard.fatigue_max_factor = 2.3800751178618507;
	m_EliteStandard.recovery_nonlinear_coeff = 0.17431516387980697;
	m_EliteStandard.fast_recovery_multiplier = 3.8138882560295464;
	m_EliteStandard.medium_recovery_multiplier = 1.737934662449431;
	m_EliteStandard.slow_recovery_multiplier = 0.5448253330733812;
	m_EliteStandard.marginal_decay_threshold = 0.8685545518850943;
	m_EliteStandard.marginal_decay_coeff = 1.0605735136506107;
	m_EliteStandard.min_recovery_stamina_threshold = 0.16981448810968178;
	m_EliteStandard.min_recovery_rest_time_seconds = 21.659228597173012;
	m_EliteStandard.sprint_speed_boost = 0.33047613260884545;
	m_EliteStandard.posture_crouch_multiplier = 1.9029780639140201;
	m_EliteStandard.posture_prone_multiplier = 2.7917965399263376;
	m_EliteStandard.jump_height_guess = 0.9051021243089914;
	m_EliteStandard.jump_horizontal_speed_guess = 0.7806948762746404;
	m_EliteStandard.slope_uphill_coeff = 0.08;
	m_EliteStandard.slope_downhill_coeff = 0.03;
	m_EliteStandard.swimming_base_power = 18.107681847972575;
	m_EliteStandard.swimming_encumbrance_threshold = 25.69676586574701;
	m_EliteStandard.swimming_static_drain_multiplier = 3.1385865502344523;
	m_EliteStandard.swimming_dynamic_power_efficiency = 1.835312141259621;
	m_EliteStandard.swimming_energy_to_stamina_coeff = 5.5418740749693576e-05;
	m_EliteStandard.env_heat_stress_max_multiplier = 1.2371015170631547;
	m_EliteStandard.env_rain_weight_max = 9.11757140272684;
	m_EliteStandard.env_wind_resistance_coeff = 0.03127994074727794;
	m_EliteStandard.env_mud_penalty_max = 0.39959321214429805;
	m_EliteStandard.env_temperature_heat_penalty_coeff = 0.023614364634832664;
	m_EliteStandard.env_temperature_cold_recovery_penalty_coeff = 0.04172990548042795;
}
...
protected void InitStandardMilsimDefaults(bool shouldInit)
{
	...
	m_StandardMilsim.energy_to_stamina_coeff = 5.8610421350393232e-07;
	m_StandardMilsim.base_recovery_rate = 1.7573035655993587e-04;
	m_StandardMilsim.standing_recovery_multiplier = 1.4417101098365601;
	m_StandardMilsim.prone_recovery_multiplier = 2.184452617854535;
	m_StandardMilsim.load_recovery_penalty_coeff = 1.9226493631394653e-05;
	m_StandardMilsim.load_recovery_penalty_exponent = 1.3996758904418702;
	m_StandardMilsim.encumbrance_speed_penalty_coeff = 0.14330858775314304;
	m_StandardMilsim.encumbrance_speed_penalty_exponent = 1.5;
	m_StandardMilsim.encumbrance_speed_penalty_max = 0.6859012465629161;
	m_StandardMilsim.encumbrance_stamina_drain_coeff = 1.4028468677913009;
	m_StandardMilsim.fatigue_accumulation_coeff = 0.006089600125080997;
	m_StandardMilsim.fatigue_max_factor = 2.9032819281966047;
	m_StandardMilsim.recovery_nonlinear_coeff = 0.3352800595318403;
	m_StandardMilsim.fast_recovery_multiplier = 2.229991085487884;
	m_StandardMilsim.medium_recovery_multiplier = 1.3348126729762309;
	m_StandardMilsim.slow_recovery_multiplier = 0.6422568082780739;
	m_StandardMilsim.marginal_decay_threshold = 0.8790088575594968;
	m_StandardMilsim.marginal_decay_coeff = 1.0832238865896615;
	m_StandardMilsim.min_recovery_stamina_threshold = 0.20785964696795464;
	m_StandardMilsim.min_recovery_rest_time_seconds = 9.800671687486604;
	m_StandardMilsim.sprint_speed_boost = 0.33581627623391264;
	m_StandardMilsim.posture_crouch_multiplier = 1.8870993297645933;
	m_StandardMilsim.posture_prone_multiplier = 2.2370497107576353;
	m_StandardMilsim.jump_height_guess = 0.7770878512004176;
	m_StandardMilsim.jump_horizontal_speed_guess = 1.0558102996424246;
	m_StandardMilsim.slope_uphill_coeff = 0.08;
	m_StandardMilsim.slope_downhill_coeff = 0.03;
	m_StandardMilsim.swimming_base_power = 20.625114161047662;
	m_StandardMilsim.swimming_encumbrance_threshold = 26.0059838227167;
	m_StandardMilsim.swimming_static_drain_multiplier = 3.0744546382907956;
	m_StandardMilsim.swimming_dynamic_power_efficiency = 1.5818644039948455;
	m_StandardMilsim.swimming_energy_to_stamina_coeff = 5.3405306894275700e-05;
	m_StandardMilsim.env_heat_stress_max_multiplier = 1.3879100039354766;
	m_StandardMilsim.env_rain_weight_max = 7.753829122165654;
	m_StandardMilsim.env_wind_resistance_coeff = 0.06439996875127203;
	m_StandardMilsim.env_mud_penalty_max = 0.30464534269222354;
	m_StandardMilsim.env_temperature_heat_penalty_coeff = 0.017513149179587552;
	m_StandardMilsim.env_temperature_cold_recovery_penalty_coeff = 0.04242806999685493;
}
...
protected void InitTacticalActionDefaults(bool shouldInit)
{
	...
	m_TacticalAction.energy_to_stamina_coeff = 5.0075281006822793e-07;
	m_TacticalAction.base_recovery_rate = 6.4426796782288175e-04;
	m_TacticalAction.standing_recovery_multiplier = 2.0527947221088136;
	m_TacticalAction.prone_recovery_multiplier = 3.0851896264182694;
	m_TacticalAction.load_recovery_penalty_coeff = 1.0591190805866779e-04;
	m_TacticalAction.load_recovery_penalty_exponent = 1.1520485674244918;
	m_TacticalAction.encumbrance_speed_penalty_coeff = 0.12749941567525452;
	m_TacticalAction.encumbrance_speed_penalty_exponent = 1.5;
	m_TacticalAction.encumbrance_speed_penalty_max = 0.5053658162046343;
	m_TacticalAction.encumbrance_stamina_drain_coeff = 0.8750212210056132;
	m_TacticalAction.fatigue_accumulation_coeff = 0.00852929609833381;
	m_TacticalAction.fatigue_max_factor = 2.881109475513953;
	m_TacticalAction.recovery_nonlinear_coeff = 0.1240354714304167;
	m_TacticalAction.fast_recovery_multiplier = 1.9086869396052544;
	m_TacticalAction.medium_recovery_multiplier = 1.088672076636559;
	m_TacticalAction.slow_recovery_multiplier = 0.5874382740481382;
	m_TacticalAction.marginal_decay_threshold = 0.8816869103758751;
	m_TacticalAction.marginal_decay_coeff = 1.096806905423429;
	m_TacticalAction.min_recovery_stamina_threshold = 0.19662994129398187;
	m_TacticalAction.min_recovery_rest_time_seconds = 20.211512849105645;
	m_TacticalAction.sprint_speed_boost = 0.2908144542803448;
	m_TacticalAction.posture_crouch_multiplier = 1.7436326770500254;
	m_TacticalAction.posture_prone_multiplier = 2.3439881712968478;
	m_TacticalAction.jump_height_guess = 0.7178374833826593;
	m_TacticalAction.jump_horizontal_speed_guess = 1.4993365548756579;
	m_TacticalAction.slope_uphill_coeff = 0.08;
	m_TacticalAction.slope_downhill_coeff = 0.03;
	m_TacticalAction.swimming_base_power = 22.69448894082047;
	m_TacticalAction.swimming_encumbrance_threshold = 23.978657030174272;
	m_TacticalAction.swimming_static_drain_multiplier = 3.327553052274047;
	m_TacticalAction.swimming_dynamic_power_efficiency = 1.6707083633124802;
	m_TacticalAction.swimming_energy_to_stamina_coeff = 4.0609273726179205e-05;
	m_TacticalAction.env_heat_stress_max_multiplier = 1.2817793489857092;
	m_TacticalAction.env_rain_weight_max = 7.361646224457038;
	m_TacticalAction.env_wind_resistance_coeff = 0.0504232302983824;
	m_TacticalAction.env_mud_penalty_max = 0.42302582810823997;
	m_TacticalAction.env_temperature_heat_penalty_coeff = 0.02410605717214422;
	m_TacticalAction.env_temperature_cold_recovery_penalty_coeff = 0.05019708019100915;
}
