...
protected void InitEliteStandardDefaults(bool shouldInit)
{
	...
	m_EliteStandard.energy_to_stamina_coeff = 2.6567177518069073e-06;
	m_EliteStandard.base_recovery_rate = 2.2307409454109346e-04;
	m_EliteStandard.standing_recovery_multiplier = 1.8993131163974115;
	m_EliteStandard.prone_recovery_multiplier = 1.775586749276945;
	m_EliteStandard.load_recovery_penalty_coeff = 1.4677072232038542e-04;
	m_EliteStandard.load_recovery_penalty_exponent = 1.2787827458731305;
	m_EliteStandard.encumbrance_speed_penalty_coeff = 0.11658589670204847;
	m_EliteStandard.encumbrance_speed_penalty_max = 0.650164378078113;
	m_EliteStandard.encumbrance_stamina_drain_coeff = 0.9182670356550262;
	m_EliteStandard.fatigue_accumulation_coeff = 0.009845184215854227;
	m_EliteStandard.fatigue_max_factor = 2.932520224473878;
	m_EliteStandard.recovery_nonlinear_coeff = 0.6047818897463845;
	m_EliteStandard.fast_recovery_multiplier = 1.6937613517021068;
	m_EliteStandard.medium_recovery_multiplier = 1.2178975080458692;
	m_EliteStandard.slow_recovery_multiplier = 0.5185445701339187;
	m_EliteStandard.marginal_decay_threshold = 0.8898481275374279;
	m_EliteStandard.marginal_decay_coeff = 1.148594156622208;
	m_EliteStandard.min_recovery_stamina_threshold = 0.1734993020540038;
	m_EliteStandard.min_recovery_rest_time_seconds = 18.39398089657505;
	m_EliteStandard.sprint_speed_boost = 0.3389142212432983;
	m_EliteStandard.posture_crouch_multiplier = 1.6168401422072383;
	m_EliteStandard.posture_prone_multiplier = 2.150144507456782;
	m_EliteStandard.jump_height_guess = 0.3078477162730962;
	m_EliteStandard.jump_horizontal_speed_guess = 0.6179436854122888;
	m_EliteStandard.slope_uphill_coeff = 0.08;
	m_EliteStandard.slope_downhill_coeff = 0.03;
	m_EliteStandard.swimming_base_power = 23.994374623947166;
	m_EliteStandard.swimming_encumbrance_threshold = 29.029796490563488;
	m_EliteStandard.swimming_static_drain_multiplier = 2.6277431275090164;
	m_EliteStandard.swimming_dynamic_power_efficiency = 1.704352480528395;
	m_EliteStandard.swimming_energy_to_stamina_coeff = 4.8160946618690674e-05;
	m_EliteStandard.env_heat_stress_max_multiplier = 1.5122498180654809;
	m_EliteStandard.env_rain_weight_max = 8.447405934126914;
	m_EliteStandard.env_wind_resistance_coeff = 0.05055398974080866;
	m_EliteStandard.env_mud_penalty_max = 0.4183863768445206;
	m_EliteStandard.env_temperature_heat_penalty_coeff = 0.015961996938022967;
	m_EliteStandard.env_temperature_cold_recovery_penalty_coeff = 0.04955327284509814;
}
...
protected void InitStandardMilsimDefaults(bool shouldInit)
{
	...
	m_StandardMilsim.energy_to_stamina_coeff = 2.2146211839085655e-06;
	m_StandardMilsim.base_recovery_rate = 2.1114394470236260e-04;
	m_StandardMilsim.standing_recovery_multiplier = 1.3037330531478915;
	m_StandardMilsim.prone_recovery_multiplier = 2.887976568518331;
	m_StandardMilsim.load_recovery_penalty_coeff = 3.0277537719803527e-05;
	m_StandardMilsim.load_recovery_penalty_exponent = 1.4010676275561411;
	m_StandardMilsim.encumbrance_speed_penalty_coeff = 0.11818622642811684;
	m_StandardMilsim.encumbrance_speed_penalty_max = 0.5547123901703912;
	m_StandardMilsim.encumbrance_stamina_drain_coeff = 1.3162493060287104;
	m_StandardMilsim.fatigue_accumulation_coeff = 0.014439129251419727;
	m_StandardMilsim.fatigue_max_factor = 2.7495967348321466;
	m_StandardMilsim.recovery_nonlinear_coeff = 0.5302899298502864;
	m_StandardMilsim.fast_recovery_multiplier = 1.4147039206323342;
	m_StandardMilsim.medium_recovery_multiplier = 1.3009657376140074;
	m_StandardMilsim.slow_recovery_multiplier = 0.643690073503744;
	m_StandardMilsim.marginal_decay_threshold = 0.7718193806118097;
	m_StandardMilsim.marginal_decay_coeff = 1.1348377138672616;
	m_StandardMilsim.min_recovery_stamina_threshold = 0.188402458197629;
	m_StandardMilsim.min_recovery_rest_time_seconds = 14.23169998124293;
	m_StandardMilsim.sprint_speed_boost = 0.2990284096817433;
	m_StandardMilsim.posture_crouch_multiplier = 1.6370663794066833;
	m_StandardMilsim.posture_prone_multiplier = 2.049497408713399;
	m_StandardMilsim.jump_height_guess = 0.7296627479338605;
	m_StandardMilsim.jump_horizontal_speed_guess = 0.6721041045680196;
	m_StandardMilsim.slope_uphill_coeff = 0.08;
	m_StandardMilsim.slope_downhill_coeff = 0.03;
	m_StandardMilsim.swimming_base_power = 21.059608074907946;
	m_StandardMilsim.swimming_encumbrance_threshold = 25.468869000288528;
	m_StandardMilsim.swimming_static_drain_multiplier = 3.298844587297175;
	m_StandardMilsim.swimming_dynamic_power_efficiency = 2.2510119123114727;
	m_StandardMilsim.swimming_energy_to_stamina_coeff = 5.5429077062757591e-05;
	m_StandardMilsim.env_heat_stress_max_multiplier = 1.3996956027766703;
	m_StandardMilsim.env_rain_weight_max = 7.415525405415722;
	m_StandardMilsim.env_wind_resistance_coeff = 0.06733746362131812;
	m_StandardMilsim.env_mud_penalty_max = 0.3108539547433108;
	m_StandardMilsim.env_temperature_heat_penalty_coeff = 0.016526213078502303;
	m_StandardMilsim.env_temperature_cold_recovery_penalty_coeff = 0.04839198184353279;
}
...
protected void InitTacticalActionDefaults(bool shouldInit)
{
	...
	m_TacticalAction.energy_to_stamina_coeff = 1.4321723499361279e-06;
	m_TacticalAction.base_recovery_rate = 1.5205251973593120e-04;
	m_TacticalAction.standing_recovery_multiplier = 1.7428357076591174;
	m_TacticalAction.prone_recovery_multiplier = 2.386514682718669;
	m_TacticalAction.load_recovery_penalty_coeff = 6.4234252595271490e-05;
	m_TacticalAction.load_recovery_penalty_exponent = 1.9383297785765186;
	m_TacticalAction.encumbrance_speed_penalty_coeff = 0.10514746529572219;
	m_TacticalAction.encumbrance_speed_penalty_max = 0.4982429160143869;
	m_TacticalAction.encumbrance_stamina_drain_coeff = 1.1552517899154016;
	m_TacticalAction.fatigue_accumulation_coeff = 0.008244201975004228;
	m_TacticalAction.fatigue_max_factor = 2.6622145812633806;
	m_TacticalAction.recovery_nonlinear_coeff = 0.36603739950006453;
	m_TacticalAction.fast_recovery_multiplier = 4.174830431140693;
	m_TacticalAction.medium_recovery_multiplier = 1.6666197087817558;
	m_TacticalAction.slow_recovery_multiplier = 0.508148390436096;
	m_TacticalAction.marginal_decay_threshold = 0.8027809425099346;
	m_TacticalAction.marginal_decay_coeff = 1.1081108521698506;
	m_TacticalAction.min_recovery_stamina_threshold = 0.1662936438969046;
	m_TacticalAction.min_recovery_rest_time_seconds = 9.41291889357914;
	m_TacticalAction.sprint_speed_boost = 0.29646191673872285;
	m_TacticalAction.posture_crouch_multiplier = 1.7153709874406475;
	m_TacticalAction.posture_prone_multiplier = 2.7425161767165136;
	m_TacticalAction.jump_height_guess = 0.6652493367004202;
	m_TacticalAction.jump_horizontal_speed_guess = 0.28814646780202896;
	m_TacticalAction.slope_uphill_coeff = 0.08;
	m_TacticalAction.slope_downhill_coeff = 0.03;
	m_TacticalAction.swimming_base_power = 17.660877358689497;
	m_TacticalAction.swimming_encumbrance_threshold = 23.840150297271844;
	m_TacticalAction.swimming_static_drain_multiplier = 3.1232589756927993;
	m_TacticalAction.swimming_dynamic_power_efficiency = 1.9400331530040054;
	m_TacticalAction.swimming_energy_to_stamina_coeff = 4.7848896883538500e-05;
	m_TacticalAction.env_heat_stress_max_multiplier = 1.425891440159598;
	m_TacticalAction.env_rain_weight_max = 6.9673399798178615;
	m_TacticalAction.env_wind_resistance_coeff = 0.033156130903383284;
	m_TacticalAction.env_mud_penalty_max = 0.3048828629644444;
	m_TacticalAction.env_temperature_heat_penalty_coeff = 0.01751259163467127;
	m_TacticalAction.env_temperature_cold_recovery_penalty_coeff = 0.04183184068288937;
}
