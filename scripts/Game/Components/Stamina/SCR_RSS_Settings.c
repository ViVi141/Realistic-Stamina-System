...
protected void InitEliteStandardDefaults(bool shouldInit)
{
	...
	m_EliteStandard.energy_to_stamina_coeff = 3.0109035394079973e-05;
	m_EliteStandard.base_recovery_rate = 2.4733277173248679e-04;
	m_EliteStandard.standing_recovery_multiplier = 1.3530460249739762;
	m_EliteStandard.prone_recovery_multiplier = 2.7083510114898446;
	m_EliteStandard.load_recovery_penalty_coeff = 1.3300885819174523e-04;
	m_EliteStandard.load_recovery_penalty_exponent = 1.132981590349533;
	m_EliteStandard.encumbrance_speed_penalty_coeff = 0.2916655372962773;
	m_EliteStandard.encumbrance_stamina_drain_coeff = 0.9172487304641103;
	m_EliteStandard.sprint_stamina_drain_multiplier = 4.073141424922933;
	m_EliteStandard.fatigue_accumulation_coeff = 0.0159324526950213;
	m_EliteStandard.fatigue_max_factor = 2.9295698792397675;
	m_EliteStandard.aerobic_efficiency_factor = 0.9105999348238167;
	m_EliteStandard.anaerobic_efficiency_factor = 1.276821555594858;
	m_EliteStandard.recovery_nonlinear_coeff = 0.6393670905722044;
	m_EliteStandard.fast_recovery_multiplier = 1.9056278643290168;
	m_EliteStandard.medium_recovery_multiplier = 1.0458191025878638;
	m_EliteStandard.slow_recovery_multiplier = 0.6391341792082769;
	m_EliteStandard.marginal_decay_threshold = 0.7830156258015598;
	m_EliteStandard.marginal_decay_coeff = 1.0649095678671434;
	m_EliteStandard.min_recovery_stamina_threshold = 0.2457819323813259;
	m_EliteStandard.min_recovery_rest_time_seconds = 3.6968785297895876;
	m_EliteStandard.sprint_speed_boost = 0.26122727583289096;
	m_EliteStandard.posture_crouch_multiplier = 0.5946781138403325;
	m_EliteStandard.posture_prone_multiplier = 0.4455497442712384;
	m_EliteStandard.jump_stamina_base_cost = 0.039534811304586394;
	m_EliteStandard.vault_stamina_start_cost = 0.024443322357482918;
	m_EliteStandard.climb_stamina_tick_cost = 0.010323655592985113;
	m_EliteStandard.jump_consecutive_penalty = 0.5251179166939506;
	m_EliteStandard.slope_uphill_coeff = 0.08442993979817238;
	m_EliteStandard.slope_downhill_coeff = 0.03431700031053622;
	m_EliteStandard.swimming_base_power = 23.271581484276233;
	m_EliteStandard.swimming_encumbrance_threshold = 27.619697445971536;
	m_EliteStandard.swimming_static_drain_multiplier = 2.762814274552942;
	m_EliteStandard.swimming_dynamic_power_efficiency = 2.066185984317375;
	m_EliteStandard.swimming_energy_to_stamina_coeff = 4.0904592618404300e-05;
	m_EliteStandard.env_heat_stress_max_multiplier = 1.2007490975676673;
	m_EliteStandard.env_rain_weight_max = 7.402597131816075;
	m_EliteStandard.env_wind_resistance_coeff = 0.03965856912796864;
	m_EliteStandard.env_mud_penalty_max = 0.4437207481380391;
	m_EliteStandard.env_temperature_heat_penalty_coeff = 0.015623177250491857;
	m_EliteStandard.env_temperature_cold_recovery_penalty_coeff = 0.043590565849873336;
}
...
protected void InitStandardMilsimDefaults(bool shouldInit)
{
	...
	m_StandardMilsim.energy_to_stamina_coeff = 3.0109035394079973e-05;
	m_StandardMilsim.base_recovery_rate = 2.4733277173248679e-04;
	m_StandardMilsim.standing_recovery_multiplier = 1.3530460249739762;
	m_StandardMilsim.prone_recovery_multiplier = 2.7083510114898446;
	m_StandardMilsim.load_recovery_penalty_coeff = 1.3300885819174523e-04;
	m_StandardMilsim.load_recovery_penalty_exponent = 1.132981590349533;
	m_StandardMilsim.encumbrance_speed_penalty_coeff = 0.2916655372962773;
	m_StandardMilsim.encumbrance_stamina_drain_coeff = 0.9172487304641103;
	m_StandardMilsim.sprint_stamina_drain_multiplier = 4.073141424922933;
	m_StandardMilsim.fatigue_accumulation_coeff = 0.0159324526950213;
	m_StandardMilsim.fatigue_max_factor = 2.9295698792397675;
	m_StandardMilsim.aerobic_efficiency_factor = 0.9105999348238167;
	m_StandardMilsim.anaerobic_efficiency_factor = 1.276821555594858;
	m_StandardMilsim.recovery_nonlinear_coeff = 0.6393670905722044;
	m_StandardMilsim.fast_recovery_multiplier = 1.9056278643290168;
	m_StandardMilsim.medium_recovery_multiplier = 1.0458191025878638;
	m_StandardMilsim.slow_recovery_multiplier = 0.6391341792082769;
	m_StandardMilsim.marginal_decay_threshold = 0.7830156258015598;
	m_StandardMilsim.marginal_decay_coeff = 1.0649095678671434;
	m_StandardMilsim.min_recovery_stamina_threshold = 0.2457819323813259;
	m_StandardMilsim.min_recovery_rest_time_seconds = 3.6968785297895876;
	m_StandardMilsim.sprint_speed_boost = 0.26122727583289096;
	m_StandardMilsim.posture_crouch_multiplier = 0.5946781138403325;
	m_StandardMilsim.posture_prone_multiplier = 0.4455497442712384;
	m_StandardMilsim.jump_stamina_base_cost = 0.039534811304586394;
	m_StandardMilsim.vault_stamina_start_cost = 0.024443322357482918;
	m_StandardMilsim.climb_stamina_tick_cost = 0.010323655592985113;
	m_StandardMilsim.jump_consecutive_penalty = 0.5251179166939506;
	m_StandardMilsim.slope_uphill_coeff = 0.08442993979817238;
	m_StandardMilsim.slope_downhill_coeff = 0.03431700031053622;
	m_StandardMilsim.swimming_base_power = 23.271581484276233;
	m_StandardMilsim.swimming_encumbrance_threshold = 27.619697445971536;
	m_StandardMilsim.swimming_static_drain_multiplier = 2.762814274552942;
	m_StandardMilsim.swimming_dynamic_power_efficiency = 2.066185984317375;
	m_StandardMilsim.swimming_energy_to_stamina_coeff = 4.0904592618404300e-05;
	m_StandardMilsim.env_heat_stress_max_multiplier = 1.2007490975676673;
	m_StandardMilsim.env_rain_weight_max = 7.402597131816075;
	m_StandardMilsim.env_wind_resistance_coeff = 0.03965856912796864;
	m_StandardMilsim.env_mud_penalty_max = 0.4437207481380391;
	m_StandardMilsim.env_temperature_heat_penalty_coeff = 0.015623177250491857;
	m_StandardMilsim.env_temperature_cold_recovery_penalty_coeff = 0.043590565849873336;
}
...
protected void InitTacticalActionDefaults(bool shouldInit)
{
	...
	m_TacticalAction.energy_to_stamina_coeff = 3.0109035394079973e-05;
	m_TacticalAction.base_recovery_rate = 2.4733277173248679e-04;
	m_TacticalAction.standing_recovery_multiplier = 1.3530460249739762;
	m_TacticalAction.prone_recovery_multiplier = 2.7083510114898446;
	m_TacticalAction.load_recovery_penalty_coeff = 1.3300885819174523e-04;
	m_TacticalAction.load_recovery_penalty_exponent = 1.132981590349533;
	m_TacticalAction.encumbrance_speed_penalty_coeff = 0.2916655372962773;
	m_TacticalAction.encumbrance_stamina_drain_coeff = 0.9172487304641103;
	m_TacticalAction.sprint_stamina_drain_multiplier = 4.073141424922933;
	m_TacticalAction.fatigue_accumulation_coeff = 0.0159324526950213;
	m_TacticalAction.fatigue_max_factor = 2.9295698792397675;
	m_TacticalAction.aerobic_efficiency_factor = 0.9105999348238167;
	m_TacticalAction.anaerobic_efficiency_factor = 1.276821555594858;
	m_TacticalAction.recovery_nonlinear_coeff = 0.6393670905722044;
	m_TacticalAction.fast_recovery_multiplier = 1.9056278643290168;
	m_TacticalAction.medium_recovery_multiplier = 1.0458191025878638;
	m_TacticalAction.slow_recovery_multiplier = 0.6391341792082769;
	m_TacticalAction.marginal_decay_threshold = 0.7830156258015598;
	m_TacticalAction.marginal_decay_coeff = 1.0649095678671434;
	m_TacticalAction.min_recovery_stamina_threshold = 0.2457819323813259;
	m_TacticalAction.min_recovery_rest_time_seconds = 3.6968785297895876;
	m_TacticalAction.sprint_speed_boost = 0.26122727583289096;
	m_TacticalAction.posture_crouch_multiplier = 0.5946781138403325;
	m_TacticalAction.posture_prone_multiplier = 0.4455497442712384;
	m_TacticalAction.jump_stamina_base_cost = 0.039534811304586394;
	m_TacticalAction.vault_stamina_start_cost = 0.024443322357482918;
	m_TacticalAction.climb_stamina_tick_cost = 0.010323655592985113;
	m_TacticalAction.jump_consecutive_penalty = 0.5251179166939506;
	m_TacticalAction.slope_uphill_coeff = 0.08442993979817238;
	m_TacticalAction.slope_downhill_coeff = 0.03431700031053622;
	m_TacticalAction.swimming_base_power = 23.271581484276233;
	m_TacticalAction.swimming_encumbrance_threshold = 27.619697445971536;
	m_TacticalAction.swimming_static_drain_multiplier = 2.762814274552942;
	m_TacticalAction.swimming_dynamic_power_efficiency = 2.066185984317375;
	m_TacticalAction.swimming_energy_to_stamina_coeff = 4.0904592618404300e-05;
	m_TacticalAction.env_heat_stress_max_multiplier = 1.2007490975676673;
	m_TacticalAction.env_rain_weight_max = 7.402597131816075;
	m_TacticalAction.env_wind_resistance_coeff = 0.03965856912796864;
	m_TacticalAction.env_mud_penalty_max = 0.4437207481380391;
	m_TacticalAction.env_temperature_heat_penalty_coeff = 0.015623177250491857;
	m_TacticalAction.env_temperature_cold_recovery_penalty_coeff = 0.043590565849873336;
}
