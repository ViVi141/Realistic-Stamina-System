...
protected void InitEliteStandardDefaults(bool shouldInit)
{
	...
	m_EliteStandard.energy_to_stamina_coeff = 3.1737902064489306e-05;
	m_EliteStandard.base_recovery_rate = 3.1812859173002618e-04;
	m_EliteStandard.standing_recovery_multiplier = 1.6255679817263675;
	m_EliteStandard.prone_recovery_multiplier = 2.083713587731364;
	m_EliteStandard.load_recovery_penalty_coeff = 1.1020478930151051e-04;
	m_EliteStandard.load_recovery_penalty_exponent = 1.9925902510012794;
	m_EliteStandard.encumbrance_speed_penalty_coeff = 0.20889226642983372;
	m_EliteStandard.encumbrance_stamina_drain_coeff = 1.0021286613582983;
	m_EliteStandard.sprint_stamina_drain_multiplier = 4.276546441435315;
	m_EliteStandard.fatigue_accumulation_coeff = 0.005055707662252088;
	m_EliteStandard.fatigue_max_factor = 2.6133797807986308;
	m_EliteStandard.aerobic_efficiency_factor = 0.908879771028625;
	m_EliteStandard.anaerobic_efficiency_factor = 1.1910965804501006;
	m_EliteStandard.recovery_nonlinear_coeff = 0.6041858425104267;
	m_EliteStandard.fast_recovery_multiplier = 2.9685970422170844;
	m_EliteStandard.medium_recovery_multiplier = 1.7449370932201937;
	m_EliteStandard.slow_recovery_multiplier = 0.7276145963491762;
	m_EliteStandard.marginal_decay_threshold = 0.8194310611980604;
	m_EliteStandard.marginal_decay_coeff = 1.094994367426886;
	m_EliteStandard.min_recovery_stamina_threshold = 0.21929089110247676;
	m_EliteStandard.min_recovery_rest_time_seconds = 3.315227018047762;
	m_EliteStandard.sprint_speed_boost = 0.31323913243283874;
	m_EliteStandard.posture_crouch_multiplier = 0.9924645542207458;
	m_EliteStandard.posture_prone_multiplier = 0.5229320611210853;
	m_EliteStandard.jump_stamina_base_cost = 0.03932794223916198;
	m_EliteStandard.vault_stamina_start_cost = 0.02445774717008461;
	m_EliteStandard.climb_stamina_tick_cost = 0.008788424155294608;
	m_EliteStandard.jump_consecutive_penalty = 0.46276536164488313;
	m_EliteStandard.slope_uphill_coeff = 0.09413268746666345;
	m_EliteStandard.slope_downhill_coeff = 0.024298252740727916;
	m_EliteStandard.swimming_base_power = 19.24850842868087;
	m_EliteStandard.swimming_encumbrance_threshold = 28.753632399007607;
	m_EliteStandard.swimming_static_drain_multiplier = 3.2044936364116845;
	m_EliteStandard.swimming_dynamic_power_efficiency = 1.687920380815323;
	m_EliteStandard.swimming_energy_to_stamina_coeff = 5.0303340567731781e-05;
	m_EliteStandard.env_heat_stress_max_multiplier = 1.4784624580551702;
	m_EliteStandard.env_rain_weight_max = 7.531195057745551;
	m_EliteStandard.env_wind_resistance_coeff = 0.04483894850368676;
	m_EliteStandard.env_mud_penalty_max = 0.4544304055231676;
	m_EliteStandard.env_temperature_heat_penalty_coeff = 0.022962414505413687;
	m_EliteStandard.env_temperature_cold_recovery_penalty_coeff = 0.04907693127613823;
}
...
protected void InitStandardMilsimDefaults(bool shouldInit)
{
	...
	m_StandardMilsim.energy_to_stamina_coeff = 3.3462194065367101e-05;
	m_StandardMilsim.base_recovery_rate = 3.0393966769732352e-04;
	m_StandardMilsim.standing_recovery_multiplier = 1.4555018889458262;
	m_StandardMilsim.prone_recovery_multiplier = 1.6011656196131032;
	m_StandardMilsim.load_recovery_penalty_coeff = 2.2702166218189105e-04;
	m_StandardMilsim.load_recovery_penalty_exponent = 1.6064390934371824;
	m_StandardMilsim.encumbrance_speed_penalty_coeff = 0.14673808976507272;
	m_StandardMilsim.encumbrance_stamina_drain_coeff = 0.8473514394690792;
	m_StandardMilsim.sprint_stamina_drain_multiplier = 3.3185015760669465;
	m_StandardMilsim.fatigue_accumulation_coeff = 0.01795997161672491;
	m_StandardMilsim.fatigue_max_factor = 2.8105170518411233;
	m_StandardMilsim.aerobic_efficiency_factor = 0.9015563058515492;
	m_StandardMilsim.anaerobic_efficiency_factor = 1.4640957121740066;
	m_StandardMilsim.recovery_nonlinear_coeff = 0.6161039615766775;
	m_StandardMilsim.fast_recovery_multiplier = 2.6267093030122903;
	m_StandardMilsim.medium_recovery_multiplier = 1.4565251132158272;
	m_StandardMilsim.slow_recovery_multiplier = 0.5391957031470389;
	m_StandardMilsim.marginal_decay_threshold = 0.858101958854977;
	m_StandardMilsim.marginal_decay_coeff = 1.079575283462033;
	m_StandardMilsim.min_recovery_stamina_threshold = 0.22942106625494055;
	m_StandardMilsim.min_recovery_rest_time_seconds = 3.0245594107785774;
	m_StandardMilsim.sprint_speed_boost = 0.2995653920883247;
	m_StandardMilsim.posture_crouch_multiplier = 0.7105594522170409;
	m_StandardMilsim.posture_prone_multiplier = 0.5081107200450621;
	m_StandardMilsim.jump_stamina_base_cost = 0.04400558447222814;
	m_StandardMilsim.vault_stamina_start_cost = 0.019105227843514278;
	m_StandardMilsim.climb_stamina_tick_cost = 0.009576761978399632;
	m_StandardMilsim.jump_consecutive_penalty = 0.569640625710579;
	m_StandardMilsim.slope_uphill_coeff = 0.07971930841832356;
	m_StandardMilsim.slope_downhill_coeff = 0.027506598158392036;
	m_StandardMilsim.swimming_base_power = 17.313487132001505;
	m_StandardMilsim.swimming_encumbrance_threshold = 28.467850018697455;
	m_StandardMilsim.swimming_static_drain_multiplier = 3.3319415416880522;
	m_StandardMilsim.swimming_dynamic_power_efficiency = 1.903519992440211;
	m_StandardMilsim.swimming_energy_to_stamina_coeff = 5.0225509244015027e-05;
	m_StandardMilsim.env_heat_stress_max_multiplier = 1.3969301920004729;
	m_StandardMilsim.env_rain_weight_max = 6.545484420117834;
	m_StandardMilsim.env_wind_resistance_coeff = 0.039533488425119875;
	m_StandardMilsim.env_mud_penalty_max = 0.3393377116462426;
	m_StandardMilsim.env_temperature_heat_penalty_coeff = 0.01986482765732423;
	m_StandardMilsim.env_temperature_cold_recovery_penalty_coeff = 0.04110664774326692;
}
...
protected void InitTacticalActionDefaults(bool shouldInit)
{
	...
	m_TacticalAction.energy_to_stamina_coeff = 3.1815928591675958e-05;
	m_TacticalAction.base_recovery_rate = 2.0459596566563102e-04;
	m_TacticalAction.standing_recovery_multiplier = 1.0755543686047426;
	m_TacticalAction.prone_recovery_multiplier = 2.273995087294009;
	m_TacticalAction.load_recovery_penalty_coeff = 4.8195531431872703e-04;
	m_TacticalAction.load_recovery_penalty_exponent = 1.5496120710962722;
	m_TacticalAction.encumbrance_speed_penalty_coeff = 0.11041448124425396;
	m_TacticalAction.encumbrance_stamina_drain_coeff = 0.8153859794127271;
	m_TacticalAction.sprint_stamina_drain_multiplier = 2.8511982586188167;
	m_TacticalAction.fatigue_accumulation_coeff = 0.0215154122788997;
	m_TacticalAction.fatigue_max_factor = 1.9227821621600998;
	m_TacticalAction.aerobic_efficiency_factor = 0.9000880206956816;
	m_TacticalAction.anaerobic_efficiency_factor = 1.5079949763669918;
	m_TacticalAction.recovery_nonlinear_coeff = 0.3672056830979453;
	m_TacticalAction.fast_recovery_multiplier = 2.9019776108216426;
	m_TacticalAction.medium_recovery_multiplier = 1.7176782465259373;
	m_TacticalAction.slow_recovery_multiplier = 0.7410442791154546;
	m_TacticalAction.marginal_decay_threshold = 0.7564069145142612;
	m_TacticalAction.marginal_decay_coeff = 1.0523638586046338;
	m_TacticalAction.min_recovery_stamina_threshold = 0.19771463759890492;
	m_TacticalAction.min_recovery_rest_time_seconds = 3.428376144355123;
	m_TacticalAction.sprint_speed_boost = 0.2630881138553576;
	m_TacticalAction.posture_crouch_multiplier = 0.6159735480579878;
	m_TacticalAction.posture_prone_multiplier = 0.42321085147566995;
	m_TacticalAction.jump_stamina_base_cost = 0.03688952670372346;
	m_TacticalAction.vault_stamina_start_cost = 0.019967668588591694;
	m_TacticalAction.climb_stamina_tick_cost = 0.01195114208085955;
	m_TacticalAction.jump_consecutive_penalty = 0.4471131869189003;
	m_TacticalAction.slope_uphill_coeff = 0.09730015812389531;
	m_TacticalAction.slope_downhill_coeff = 0.03501742135582995;
	m_TacticalAction.swimming_base_power = 22.545428740846823;
	m_TacticalAction.swimming_encumbrance_threshold = 21.031238688359327;
	m_TacticalAction.swimming_static_drain_multiplier = 3.359502975624898;
	m_TacticalAction.swimming_dynamic_power_efficiency = 2.005252372447857;
	m_TacticalAction.swimming_energy_to_stamina_coeff = 4.2567885789082506e-05;
	m_TacticalAction.env_heat_stress_max_multiplier = 1.2416438597536665;
	m_TacticalAction.env_rain_weight_max = 8.897355268514964;
	m_TacticalAction.env_wind_resistance_coeff = 0.058391402008958905;
	m_TacticalAction.env_mud_penalty_max = 0.3548321333119612;
	m_TacticalAction.env_temperature_heat_penalty_coeff = 0.019822252303373266;
	m_TacticalAction.env_temperature_cold_recovery_penalty_coeff = 0.04171316499192861;
}
