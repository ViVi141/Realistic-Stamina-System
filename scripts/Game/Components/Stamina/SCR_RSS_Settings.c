...
protected void InitEliteStandardDefaults(bool shouldInit)
{
	...
	m_EliteStandard.energy_to_stamina_coeff = 4.9200276446885630e-05;
	m_EliteStandard.base_recovery_rate = 7.8176337056877520e-04;
	m_EliteStandard.standing_recovery_multiplier = 2.1535916997395863;
	m_EliteStandard.prone_recovery_multiplier = 2.928580128598087;
	m_EliteStandard.load_recovery_penalty_coeff = 1.5214404240519700e-04;
	m_EliteStandard.load_recovery_penalty_exponent = 1.539484931747534;
	m_EliteStandard.encumbrance_speed_penalty_coeff = 0.24047974421611973;
	m_EliteStandard.encumbrance_stamina_drain_coeff = 0.8413175702879775;
	m_EliteStandard.sprint_stamina_drain_multiplier = 4.976075702039213;
	m_EliteStandard.fatigue_accumulation_coeff = 0.023281870830523275;
	m_EliteStandard.fatigue_max_factor = 2.508089253992603;
	m_EliteStandard.aerobic_efficiency_factor = 0.9998569540801108;
	m_EliteStandard.anaerobic_efficiency_factor = 1.3520102751667555;
	m_EliteStandard.recovery_nonlinear_coeff = 0.6652918745117081;
	m_EliteStandard.fast_recovery_multiplier = 2.9995685448477385;
	m_EliteStandard.medium_recovery_multiplier = 1.6977394988570211;
	m_EliteStandard.slow_recovery_multiplier = 0.5401086963198308;
	m_EliteStandard.marginal_decay_threshold = 0.7107269583041661;
	m_EliteStandard.marginal_decay_coeff = 1.080006708290544;
	m_EliteStandard.min_recovery_stamina_threshold = 0.19754757152327337;
	m_EliteStandard.min_recovery_rest_time_seconds = 3.1486772864161154;
	m_EliteStandard.sprint_speed_boost = 0.25777124183917255;
	m_EliteStandard.posture_crouch_multiplier = 2.0661801174306573;
	m_EliteStandard.posture_prone_multiplier = 2.7018653154819217;
	m_EliteStandard.jump_stamina_base_cost = 0.03164345044123465;
	m_EliteStandard.vault_stamina_start_cost = 0.022008084180017404;
	m_EliteStandard.climb_stamina_tick_cost = 0.011061265198101546;
	m_EliteStandard.jump_consecutive_penalty = 0.44070710449636097;
	m_EliteStandard.slope_uphill_coeff = 0.09732771668196075;
	m_EliteStandard.slope_downhill_coeff = 0.03595996070438448;
	m_EliteStandard.swimming_base_power = 16.5575162286553;
	m_EliteStandard.swimming_encumbrance_threshold = 24.663745945045484;
	m_EliteStandard.swimming_static_drain_multiplier = 3.380421902873605;
	m_EliteStandard.swimming_dynamic_power_efficiency = 1.9337237028314211;
	m_EliteStandard.swimming_energy_to_stamina_coeff = 4.8241872192650786e-05;
	m_EliteStandard.env_heat_stress_max_multiplier = 1.468405192213164;
	m_EliteStandard.env_rain_weight_max = 6.142448601091366;
	m_EliteStandard.env_wind_resistance_coeff = 0.05049042255505042;
	m_EliteStandard.env_mud_penalty_max = 0.49532352746300184;
	m_EliteStandard.env_temperature_heat_penalty_coeff = 0.021250915526865286;
	m_EliteStandard.env_temperature_cold_recovery_penalty_coeff = 0.056036803369056115;
}
...
protected void InitStandardMilsimDefaults(bool shouldInit)
{
	...
	m_StandardMilsim.energy_to_stamina_coeff = 6.7177732048617116e-05;
	m_StandardMilsim.base_recovery_rate = 7.9594520030649638e-04;
	m_StandardMilsim.standing_recovery_multiplier = 2.4717155976877327;
	m_StandardMilsim.prone_recovery_multiplier = 2.567584208619073;
	m_StandardMilsim.load_recovery_penalty_coeff = 1.3218116957614047e-04;
	m_StandardMilsim.load_recovery_penalty_exponent = 2.0597512510364124;
	m_StandardMilsim.encumbrance_speed_penalty_coeff = 0.22298060291338723;
	m_StandardMilsim.encumbrance_stamina_drain_coeff = 1.5122731224545432;
	m_StandardMilsim.sprint_stamina_drain_multiplier = 3.28117434859544;
	m_StandardMilsim.fatigue_accumulation_coeff = 0.015249204685490467;
	m_StandardMilsim.fatigue_max_factor = 2.9717667551434417;
	m_StandardMilsim.aerobic_efficiency_factor = 1.0027512309146436;
	m_StandardMilsim.anaerobic_efficiency_factor = 1.1681284834500991;
	m_StandardMilsim.recovery_nonlinear_coeff = 0.6112100972578612;
	m_StandardMilsim.fast_recovery_multiplier = 2.954961274256177;
	m_StandardMilsim.medium_recovery_multiplier = 1.7760813626432683;
	m_StandardMilsim.slow_recovery_multiplier = 0.6564378916164416;
	m_StandardMilsim.marginal_decay_threshold = 0.8954615815983007;
	m_StandardMilsim.marginal_decay_coeff = 1.1191505545813594;
	m_StandardMilsim.min_recovery_stamina_threshold = 0.1661671436236962;
	m_StandardMilsim.min_recovery_rest_time_seconds = 2.90760042587188;
	m_StandardMilsim.sprint_speed_boost = 0.3218331175372004;
	m_StandardMilsim.posture_crouch_multiplier = 1.8468287263037373;
	m_StandardMilsim.posture_prone_multiplier = 2.2516792834382082;
	m_StandardMilsim.jump_stamina_base_cost = 0.038332009580932386;
	m_StandardMilsim.vault_stamina_start_cost = 0.01662699743808566;
	m_StandardMilsim.climb_stamina_tick_cost = 0.010260341249811025;
	m_StandardMilsim.jump_consecutive_penalty = 0.487971127942767;
	m_StandardMilsim.slope_uphill_coeff = 0.07995582658143768;
	m_StandardMilsim.slope_downhill_coeff = 0.02024206233552215;
	m_StandardMilsim.swimming_base_power = 23.833497010221038;
	m_StandardMilsim.swimming_encumbrance_threshold = 23.11703321492812;
	m_StandardMilsim.swimming_static_drain_multiplier = 2.9957170100782755;
	m_StandardMilsim.swimming_dynamic_power_efficiency = 1.7286767796036089;
	m_StandardMilsim.swimming_energy_to_stamina_coeff = 5.2687273777433747e-05;
	m_StandardMilsim.env_heat_stress_max_multiplier = 1.2888303482773282;
	m_StandardMilsim.env_rain_weight_max = 7.286679958638194;
	m_StandardMilsim.env_wind_resistance_coeff = 0.06392168358405936;
	m_StandardMilsim.env_mud_penalty_max = 0.3626501480977644;
	m_StandardMilsim.env_temperature_heat_penalty_coeff = 0.015953992773132107;
	m_StandardMilsim.env_temperature_cold_recovery_penalty_coeff = 0.057622102967131314;
}
...
protected void InitTacticalActionDefaults(bool shouldInit)
{
	...
	m_TacticalAction.energy_to_stamina_coeff = 3.5814940232877659e-05;
	m_TacticalAction.base_recovery_rate = 7.9594520030649638e-04;
	m_TacticalAction.standing_recovery_multiplier = 2.4717155976877327;
	m_TacticalAction.prone_recovery_multiplier = 2.567584208619073;
	m_TacticalAction.load_recovery_penalty_coeff = 1.7888158336725219e-04;
	m_TacticalAction.load_recovery_penalty_exponent = 1.5190835663521807;
	m_TacticalAction.encumbrance_speed_penalty_coeff = 0.10420183139727215;
	m_TacticalAction.encumbrance_stamina_drain_coeff = 0.8413175702879775;
	m_TacticalAction.sprint_stamina_drain_multiplier = 2.9607794364594326;
	m_TacticalAction.fatigue_accumulation_coeff = 0.015249204685490467;
	m_TacticalAction.fatigue_max_factor = 2.2835598959502015;
	m_TacticalAction.aerobic_efficiency_factor = 0.8812273909906321;
	m_TacticalAction.anaerobic_efficiency_factor = 1.292468356785691;
	m_TacticalAction.recovery_nonlinear_coeff = 0.6652918745117081;
	m_TacticalAction.fast_recovery_multiplier = 2.954961274256177;
	m_TacticalAction.medium_recovery_multiplier = 1.7760813626432683;
	m_TacticalAction.slow_recovery_multiplier = 0.6564378916164416;
	m_TacticalAction.marginal_decay_threshold = 0.8954615815983007;
	m_TacticalAction.marginal_decay_coeff = 1.1257310207134439;
	m_TacticalAction.min_recovery_stamina_threshold = 0.21771907236726554;
	m_TacticalAction.min_recovery_rest_time_seconds = 2.90760042587188;
	m_TacticalAction.sprint_speed_boost = 0.3218331175372004;
	m_TacticalAction.posture_crouch_multiplier = 2.042019470113924;
	m_TacticalAction.posture_prone_multiplier = 2.5843691101293325;
	m_TacticalAction.jump_stamina_base_cost = 0.04456538971997976;
	m_TacticalAction.vault_stamina_start_cost = 0.01662699743808566;
	m_TacticalAction.climb_stamina_tick_cost = 0.011061265198101546;
	m_TacticalAction.jump_consecutive_penalty = 0.5748207592132422;
	m_TacticalAction.slope_uphill_coeff = 0.07436283116172605;
	m_TacticalAction.slope_downhill_coeff = 0.02024206233552215;
	m_TacticalAction.swimming_base_power = 15.454865414722747;
	m_TacticalAction.swimming_encumbrance_threshold = 28.456263001150187;
	m_TacticalAction.swimming_static_drain_multiplier = 3.411234310314671;
	m_TacticalAction.swimming_dynamic_power_efficiency = 2.320627393419037;
	m_TacticalAction.swimming_energy_to_stamina_coeff = 4.2558998818395297e-05;
	m_TacticalAction.env_heat_stress_max_multiplier = 1.2888303482773282;
	m_TacticalAction.env_rain_weight_max = 7.286679958638194;
	m_TacticalAction.env_wind_resistance_coeff = 0.05870704631173999;
	m_TacticalAction.env_mud_penalty_max = 0.49958302688245754;
	m_TacticalAction.env_temperature_heat_penalty_coeff = 0.01758584221552774;
	m_TacticalAction.env_temperature_cold_recovery_penalty_coeff = 0.0544840982561674;
}
