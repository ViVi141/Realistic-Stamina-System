...
protected void InitEliteStandardDefaults(bool shouldInit)
{
	...
	m_EliteStandard.energy_to_stamina_coeff = 8.6435526568012687e-07;
	m_EliteStandard.base_recovery_rate = 1.6234616393570565e-04;
	m_EliteStandard.standing_recovery_multiplier = 1.7983668851471908;
	m_EliteStandard.prone_recovery_multiplier = 3.3989908634783235;
	m_EliteStandard.load_recovery_penalty_coeff = 1.0298276806262319e-05;
	m_EliteStandard.load_recovery_penalty_exponent = 1.5990126371146123;
	m_EliteStandard.encumbrance_speed_penalty_coeff = 0.20275211842288976;
	m_EliteStandard.encumbrance_speed_penalty_exponent = 1.234924145592768;
	m_EliteStandard.encumbrance_speed_penalty_max = 0.7792604260785807;
	m_EliteStandard.encumbrance_stamina_drain_coeff = 1.290612394070082;
	m_EliteStandard.fatigue_accumulation_coeff = 0.007234073162377945;
	m_EliteStandard.fatigue_max_factor = 2.104130428121163;
	m_EliteStandard.recovery_nonlinear_coeff = 0.1455761721789501;
	m_EliteStandard.fast_recovery_multiplier = 2.1936592991633046;
	m_EliteStandard.medium_recovery_multiplier = 1.140654069060721;
	m_EliteStandard.slow_recovery_multiplier = 0.7086221445767917;
	m_EliteStandard.marginal_decay_threshold = 0.7242162596482925;
	m_EliteStandard.marginal_decay_coeff = 1.136465911388989;
	m_EliteStandard.min_recovery_stamina_threshold = 0.19934442792827387;
	m_EliteStandard.min_recovery_rest_time_seconds = 16.442937555728005;
	m_EliteStandard.sprint_speed_boost = 0.31986028781663983;
	m_EliteStandard.posture_crouch_multiplier = 1.6104931145413417;
	...
	m_EliteStandard.swimming_encumbrance_threshold = 23.067727513528325;
	m_EliteStandard.swimming_static_drain_multiplier = 2.9752274670017402;
	...
	m_EliteStandard.env_rain_weight_max = 4.5;
	...
	m_EliteStandard.env_temperature_cold_recovery_penalty_coeff = 0.04875995495791108;
}
...
protected void InitStandardMilsimDefaults(bool shouldInit)
{
	...
	m_StandardMilsim.energy_to_stamina_coeff = 8.9293543281366954e-07;
	m_StandardMilsim.base_recovery_rate = 6.7829079179066885e-04;
	m_StandardMilsim.standing_recovery_multiplier = 1.3364492259358276;
	m_StandardMilsim.prone_recovery_multiplier = 2.536730926670641;
	m_StandardMilsim.load_recovery_penalty_coeff = 4.9181662673447002e-05;
	m_StandardMilsim.load_recovery_penalty_exponent = 1.2531989070128102;
	m_StandardMilsim.encumbrance_speed_penalty_coeff = 0.1964432142252763;
	m_StandardMilsim.encumbrance_speed_penalty_exponent = 2.635644147132381;
	m_StandardMilsim.encumbrance_speed_penalty_max = 0.938421045720064;
	m_StandardMilsim.encumbrance_stamina_drain_coeff = 1.4022434372294046;
	m_StandardMilsim.fatigue_accumulation_coeff = 0.01129783607707972;
	m_StandardMilsim.fatigue_max_factor = 2.630213408169721;
	m_StandardMilsim.recovery_nonlinear_coeff = 0.17948239380515596;
	m_StandardMilsim.fast_recovery_multiplier = 1.757661256777193;
	m_StandardMilsim.medium_recovery_multiplier = 1.4781847401504784;
	m_StandardMilsim.slow_recovery_multiplier = 0.6640746541379373;
	m_StandardMilsim.marginal_decay_threshold = 0.7835968171013827;
	m_StandardMilsim.marginal_decay_coeff = 1.13532847985672;
	m_StandardMilsim.min_recovery_stamina_threshold = 0.23561536219946602;
	m_StandardMilsim.min_recovery_rest_time_seconds = 6.9847532983936205;
	m_StandardMilsim.sprint_speed_boost = 0.2863504617923482;
	m_StandardMilsim.posture_crouch_multiplier = 1.4626954770019354;
	...
	m_StandardMilsim.swimming_encumbrance_threshold = 27.889139629658672;
	m_StandardMilsim.swimming_static_drain_multiplier = 2.7336904488253637;
	...
	m_StandardMilsim.env_temperature_cold_recovery_penalty_coeff = 0.04254220981734048;
}
...
protected void InitTacticalActionDefaults(bool shouldInit)
{
	...
	m_TacticalAction.energy_to_stamina_coeff = 5.9373666120588918e-07;
	m_TacticalAction.base_recovery_rate = 2.1973223293301895e-04;
	m_TacticalAction.standing_recovery_multiplier = 1.5170355409079903;
	m_TacticalAction.prone_recovery_multiplier = 3.2005974731435836;
	m_TacticalAction.load_recovery_penalty_coeff = 3.2066623220366726e-04;
	m_TacticalAction.load_recovery_penalty_exponent = 1.5902990717555996;
	m_TacticalAction.encumbrance_speed_penalty_coeff = 0.1756008562535828;
	m_TacticalAction.encumbrance_speed_penalty_exponent = 2.69083840340154;
	m_TacticalAction.encumbrance_speed_penalty_max = 0.5632401127785114;
	m_TacticalAction.encumbrance_stamina_drain_coeff = 1.225118865593151;
	m_TacticalAction.fatigue_accumulation_coeff = 0.02534764540563692;
	m_TacticalAction.fatigue_max_factor = 2.8514452440581457;
	m_TacticalAction.recovery_nonlinear_coeff = 0.6858896657205225;
	m_TacticalAction.fast_recovery_multiplier = 3.884176887603295;
	m_TacticalAction.medium_recovery_multiplier = 0.996477841438365;
	m_TacticalAction.slow_recovery_multiplier = 0.7705514949325014;
	m_TacticalAction.marginal_decay_threshold = 0.7819676956219188;
	m_TacticalAction.marginal_decay_coeff = 1.1490801355945937;
	m_TacticalAction.min_recovery_stamina_threshold = 0.1972280964328801;
	m_TacticalAction.min_recovery_rest_time_seconds = 16.076721650044412;
	m_TacticalAction.sprint_speed_boost = 0.3170842440679759;
	m_TacticalAction.posture_crouch_multiplier = 1.5217370298582777;
	...
	m_TacticalAction.swimming_encumbrance_threshold = 24.091437879176222;
	m_TacticalAction.swimming_static_drain_multiplier = 2.754021149095563;
	...
	m_TacticalAction.env_rain_weight_max = 4.0;
	...
	m_TacticalAction.env_temperature_cold_recovery_penalty_coeff = 0.04416767358017651;
}
