...
protected void InitStandardMilsimDefaults(bool shouldInit)
{
	...
	m_StandardMilsim.energy_to_stamina_coeff = 9.3806397729979624e-07;
	m_StandardMilsim.base_recovery_rate = 1.0613100967707954e-04;
	m_StandardMilsim.standing_recovery_multiplier = 1.3218196992188518;
	m_StandardMilsim.prone_recovery_multiplier = 1.6222923620953724;
	m_StandardMilsim.load_recovery_penalty_coeff = 1.0527350751344664e-04;
	m_StandardMilsim.load_recovery_penalty_exponent = 1.8133433290451082;
	m_StandardMilsim.encumbrance_speed_penalty_coeff = 0.1143693228742078;
	m_StandardMilsim.encumbrance_speed_penalty_max = 0.4218948144192853;
	m_StandardMilsim.encumbrance_stamina_drain_coeff = 0.9351480504577316;
	m_StandardMilsim.load_metabolic_dampening = 0.7249510041609453;
	m_StandardMilsim.max_recovery_per_tick = 3.8320584972637831e-04;
	m_StandardMilsim.fatigue_accumulation_coeff = 0.006790337748623497;
	m_StandardMilsim.fatigue_max_factor = 2.489320492638959;
	m_StandardMilsim.recovery_nonlinear_coeff = 0.5296081845597062;
	m_StandardMilsim.fast_recovery_multiplier = 2.227447271030478;
	m_StandardMilsim.medium_recovery_multiplier = 1.7247700838926887;
	m_StandardMilsim.slow_recovery_multiplier = 0.6961764109777254;
	m_StandardMilsim.marginal_decay_threshold = 0.772853972209615;
	m_StandardMilsim.marginal_decay_coeff = 1.1087103355063037;
	...
	m_StandardMilsim.swimming_encumbrance_threshold = 22.768776481472038;
	m_StandardMilsim.swimming_static_drain_multiplier = 3.3062012797930613;
	m_StandardMilsim.swimming_dynamic_power_efficiency = 2.313262301350654;
	m_StandardMilsim.swimming_energy_to_stamina_coeff = 4.3690420387127551e-05;
	m_StandardMilsim.env_heat_stress_max_multiplier = 1.3332816928503437;
	m_StandardMilsim.env_rain_weight_max = 8.801903605286162;
	m_StandardMilsim.env_wind_resistance_coeff = 0.06664935333252861;
...
protected void InitTacticalActionDefaults(bool shouldInit)
{
	...
	m_TacticalAction.base_recovery_rate = 2.5321773593304700e-04;
	m_TacticalAction.standing_recovery_multiplier = 1.1567841477614096;
	m_TacticalAction.prone_recovery_multiplier = 2.8632131803366185;
	m_TacticalAction.load_recovery_penalty_coeff = 3.6659686889422600e-04;
	m_TacticalAction.load_recovery_penalty_exponent = 1.304253283409762;
	m_TacticalAction.encumbrance_speed_penalty_coeff = 0.14434242324990731;
	m_TacticalAction.encumbrance_speed_penalty_max = 0.5388920995437136;
	m_TacticalAction.encumbrance_stamina_drain_coeff = 1.278035499621776;
	m_TacticalAction.load_metabolic_dampening = 0.57874953695615;
	m_TacticalAction.max_recovery_per_tick = 3.4825685882675637e-04;
	m_TacticalAction.fatigue_accumulation_coeff = 0.005282957699677724;
	m_TacticalAction.fatigue_max_factor = 1.9929968180548738;
	m_TacticalAction.recovery_nonlinear_coeff = 0.503511073646223;
	m_TacticalAction.fast_recovery_multiplier = 2.54910228154623;
	m_TacticalAction.medium_recovery_multiplier = 1.1503367973874892;
	m_TacticalAction.slow_recovery_multiplier = 0.6536945933769986;
	m_TacticalAction.marginal_decay_threshold = 0.7323965853859649;
	m_TacticalAction.marginal_decay_coeff = 1.0994420304702581;
	...
	m_TacticalAction.swimming_encumbrance_threshold = 20.662395020883537;
	m_TacticalAction.swimming_static_drain_multiplier = 2.95746699230291;
	m_TacticalAction.swimming_dynamic_power_efficiency = 1.693036162214321;
	m_TacticalAction.swimming_energy_to_stamina_coeff = 5.4754414723363789e-05;
	m_TacticalAction.env_heat_stress_max_multiplier = 1.2630830578847805;
	m_TacticalAction.env_rain_weight_max = 7.086605278196775;
	m_TacticalAction.env_wind_resistance_coeff = 0.03928024805127229;
