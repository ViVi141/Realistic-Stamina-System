...
protected void InitEliteStandardDefaults(bool shouldInit)
{
	...
	m_EliteStandard.energy_to_stamina_coeff = 9.0758565357021829e-07;
	m_EliteStandard.base_recovery_rate = 7.0003700353370125e-04;
	m_EliteStandard.standing_recovery_multiplier = 1.4692947058232493;
	m_EliteStandard.prone_recovery_multiplier = 3.1110537248100667;
	m_EliteStandard.load_recovery_penalty_coeff = 1.1922951013935390e-04;
	m_EliteStandard.load_recovery_penalty_exponent = 1.9130330980537908;
	m_EliteStandard.encumbrance_speed_penalty_coeff = 0.10471067309264465;
	m_EliteStandard.encumbrance_speed_penalty_max = 0.6475644984713719;
	m_EliteStandard.encumbrance_stamina_drain_coeff = 1.2379360414984448;
	m_EliteStandard.fatigue_accumulation_coeff = 0.010429376146688736;
	m_EliteStandard.fatigue_max_factor = 2.239281508357405;
	m_EliteStandard.recovery_nonlinear_coeff = 0.5186818509431672;
	m_EliteStandard.fast_recovery_multiplier = 1.8292376099991083;
	m_EliteStandard.medium_recovery_multiplier = 1.727112731706776;
	m_EliteStandard.slow_recovery_multiplier = 0.5102293585000259;
	m_EliteStandard.marginal_decay_threshold = 0.7910599695494687;
	m_EliteStandard.marginal_decay_coeff = 1.0650964993130294;
	m_EliteStandard.min_recovery_stamina_threshold = 0.2323574277351307;
	m_EliteStandard.min_recovery_rest_time_seconds = 11.273218183513372;
	m_EliteStandard.sprint_speed_boost = 0.3117865481223033;
	m_EliteStandard.posture_crouch_multiplier = 1.7143753706491558;
	m_EliteStandard.posture_prone_multiplier = 2.618001572547765;
	m_EliteStandard.jump_height_guess = 0.6368010518571827;
	m_EliteStandard.jump_horizontal_speed_guess = 1.183437502515519;
	m_EliteStandard.slope_uphill_coeff = 0.08;
	m_EliteStandard.slope_downhill_coeff = 0.03;
	m_EliteStandard.swimming_base_power = 15.735082768026752;
	m_EliteStandard.swimming_encumbrance_threshold = 21.91593967902995;
	m_EliteStandard.swimming_static_drain_multiplier = 3.0515342496463607;
	m_EliteStandard.swimming_dynamic_power_efficiency = 2.447088324752695;
	m_EliteStandard.swimming_energy_to_stamina_coeff = 4.1495156934435609e-05;
	m_EliteStandard.env_heat_stress_max_multiplier = 1.2172336864627458;
	m_EliteStandard.env_rain_weight_max = 6.626202699711422;
	m_EliteStandard.env_wind_resistance_coeff = 0.05564612515440626;
	m_EliteStandard.env_mud_penalty_max = 0.3797985833340494;
	m_EliteStandard.env_temperature_heat_penalty_coeff = 0.023255523794176863;
	m_EliteStandard.env_temperature_cold_recovery_penalty_coeff = 0.041438663029627315;
}
...
protected void InitStandardMilsimDefaults(bool shouldInit)
{
	...
	m_StandardMilsim.energy_to_stamina_coeff = 5.3052044753986131e-07;
	m_StandardMilsim.base_recovery_rate = 1.8771650780429559e-04;
	m_StandardMilsim.standing_recovery_multiplier = 1.7724378556691798;
	m_StandardMilsim.prone_recovery_multiplier = 2.145845121821348;
	m_StandardMilsim.load_recovery_penalty_coeff = 3.4391093351009822e-04;
	m_StandardMilsim.load_recovery_penalty_exponent = 1.3958368087568958;
	m_StandardMilsim.encumbrance_speed_penalty_coeff = 0.12977665954344414;
	m_StandardMilsim.encumbrance_speed_penalty_max = 0.47367501048215993;
	m_StandardMilsim.encumbrance_stamina_drain_coeff = 0.8001001110052605;
	m_StandardMilsim.fatigue_accumulation_coeff = 0.013429553966065315;
	m_StandardMilsim.fatigue_max_factor = 1.6225721355544573;
	m_StandardMilsim.recovery_nonlinear_coeff = 0.6785493046217375;
	m_StandardMilsim.fast_recovery_multiplier = 4.498264540928243;
	m_StandardMilsim.medium_recovery_multiplier = 1.5456102528630062;
	m_StandardMilsim.slow_recovery_multiplier = 0.5392532312300781;
	m_StandardMilsim.marginal_decay_threshold = 0.7276929192139351;
	m_StandardMilsim.marginal_decay_coeff = 1.0923943084939824;
	m_StandardMilsim.min_recovery_stamina_threshold = 0.22804236689714766;
	m_StandardMilsim.min_recovery_rest_time_seconds = 5.643802996999366;
	m_StandardMilsim.sprint_speed_boost = 0.3282847925798031;
	m_StandardMilsim.posture_crouch_multiplier = 1.5401866689453998;
	m_StandardMilsim.posture_prone_multiplier = 2.1892161138185813;
	m_StandardMilsim.jump_height_guess = 0.41205331374535226;
	m_StandardMilsim.jump_horizontal_speed_guess = 1.3610046474704043;
	m_StandardMilsim.slope_uphill_coeff = 0.08;
	m_StandardMilsim.slope_downhill_coeff = 0.03;
	m_StandardMilsim.swimming_base_power = 16.80456716781681;
	m_StandardMilsim.swimming_encumbrance_threshold = 20.40434095515157;
	m_StandardMilsim.swimming_static_drain_multiplier = 3.087625678447762;
	m_StandardMilsim.swimming_dynamic_power_efficiency = 1.8461809254097021;
	m_StandardMilsim.swimming_energy_to_stamina_coeff = 4.8114124412827331e-05;
	m_StandardMilsim.env_heat_stress_max_multiplier = 1.2476250979450187;
	m_StandardMilsim.env_rain_weight_max = 8.992937965732779;
	m_StandardMilsim.env_wind_resistance_coeff = 0.054062145985740724;
	m_StandardMilsim.env_mud_penalty_max = 0.372843408949656;
	m_StandardMilsim.env_temperature_heat_penalty_coeff = 0.01671574943763136;
	m_StandardMilsim.env_temperature_cold_recovery_penalty_coeff = 0.051869034783411205;
}
...
protected void InitTacticalActionDefaults(bool shouldInit)
{
	...
	m_TacticalAction.energy_to_stamina_coeff = 5.1115856762177631e-07;
	m_TacticalAction.base_recovery_rate = 2.4123873798156907e-04;
	m_TacticalAction.standing_recovery_multiplier = 1.4233702740830247;
	m_TacticalAction.prone_recovery_multiplier = 1.738599161203625;
	m_TacticalAction.load_recovery_penalty_coeff = 1.6185863434809861e-06;
	m_TacticalAction.load_recovery_penalty_exponent = 1.5932594701753773;
	m_TacticalAction.encumbrance_speed_penalty_coeff = 0.11136086341779153;
	m_TacticalAction.encumbrance_speed_penalty_max = 0.5083728382123032;
	m_TacticalAction.encumbrance_stamina_drain_coeff = 1.4896141729040135;
	m_TacticalAction.fatigue_accumulation_coeff = 0.00796949403712578;
	m_TacticalAction.fatigue_max_factor = 2.8735370250774563;
	m_TacticalAction.recovery_nonlinear_coeff = 0.39876283203736373;
	m_TacticalAction.fast_recovery_multiplier = 1.9261583742374158;
	m_TacticalAction.medium_recovery_multiplier = 1.7129472661543068;
	m_TacticalAction.slow_recovery_multiplier = 0.6196509844519267;
	m_TacticalAction.marginal_decay_threshold = 0.7178956765964835;
	m_TacticalAction.marginal_decay_coeff = 1.115197371392296;
	m_TacticalAction.min_recovery_stamina_threshold = 0.19869407132392483;
	m_TacticalAction.min_recovery_rest_time_seconds = 20.808305006384202;
	m_TacticalAction.sprint_speed_boost = 0.3441389586140472;
	m_TacticalAction.posture_crouch_multiplier = 1.6941834388357737;
	m_TacticalAction.posture_prone_multiplier = 2.477128021267717;
	m_TacticalAction.jump_height_guess = 0.650487639456717;
	m_TacticalAction.jump_horizontal_speed_guess = 1.4724159834636494;
	m_TacticalAction.slope_uphill_coeff = 0.08;
	m_TacticalAction.slope_downhill_coeff = 0.03;
	m_TacticalAction.swimming_base_power = 23.310844073565953;
	m_TacticalAction.swimming_encumbrance_threshold = 29.117377082773537;
	m_TacticalAction.swimming_static_drain_multiplier = 2.7543400875776043;
	m_TacticalAction.swimming_dynamic_power_efficiency = 2.2725264231625943;
	m_TacticalAction.swimming_energy_to_stamina_coeff = 4.5309464499952983e-05;
	m_TacticalAction.env_heat_stress_max_multiplier = 1.283497013371356;
	m_TacticalAction.env_rain_weight_max = 9.777064638622203;
	m_TacticalAction.env_wind_resistance_coeff = 0.030772176668714665;
	m_TacticalAction.env_mud_penalty_max = 0.49307774073268595;
	m_TacticalAction.env_temperature_heat_penalty_coeff = 0.016492618969888063;
	m_TacticalAction.env_temperature_cold_recovery_penalty_coeff = 0.05638876163586536;
}
