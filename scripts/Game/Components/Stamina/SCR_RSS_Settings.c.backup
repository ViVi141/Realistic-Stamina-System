...
protected void InitEliteStandardDefaults(bool shouldInit)
{
	...
	m_EliteStandard.energy_to_stamina_coeff = 3.0265337969563792e-05;
	m_EliteStandard.base_recovery_rate = 4.4755025160347033e-04;
	m_EliteStandard.standing_recovery_multiplier = 1.984527950344009;
	m_EliteStandard.prone_recovery_multiplier = 2.529993266742613;
	m_EliteStandard.load_recovery_penalty_coeff = 1.2006273832912313e-04;
	m_EliteStandard.load_recovery_penalty_exponent = 1.3335257117395856;
	m_EliteStandard.encumbrance_speed_penalty_coeff = 0.10028944410419988;
	m_EliteStandard.encumbrance_stamina_drain_coeff = 0.8069247935515617;
	m_EliteStandard.sprint_stamina_drain_multiplier = 4.804898004656696;
	m_EliteStandard.fatigue_accumulation_coeff = 0.017554979422976742;
	m_EliteStandard.fatigue_max_factor = 2.8803239788032786;
	m_EliteStandard.aerobic_efficiency_factor = 0.8838456647116071;
	m_EliteStandard.anaerobic_efficiency_factor = 1.2221211277123643;
	m_EliteStandard.recovery_nonlinear_coeff = 0.687124541288223;
	m_EliteStandard.fast_recovery_multiplier = 3.4883146663592117;
	m_EliteStandard.medium_recovery_multiplier = 2.146451090799627;
	m_EliteStandard.slow_recovery_multiplier = 0.9362987179176496;
	m_EliteStandard.marginal_decay_threshold = 0.8880920387112783;
	m_EliteStandard.marginal_decay_coeff = 1.124693478760589;
	m_EliteStandard.min_recovery_stamina_threshold = 0.23669460143678803;
	m_EliteStandard.min_recovery_rest_time_seconds = 4.936146099497652;
	m_EliteStandard.sprint_speed_boost = 0.3042754588389501;
	m_EliteStandard.posture_crouch_multiplier = 0.516143363699651;
	m_EliteStandard.posture_prone_multiplier = 0.4596346682324443;
	m_EliteStandard.jump_stamina_base_cost = 0.025979384857862026;
	m_EliteStandard.vault_stamina_start_cost = 0.019170280672000665;
	m_EliteStandard.climb_stamina_tick_cost = 0.01024601461296585;
	m_EliteStandard.jump_consecutive_penalty = 0.4029657908719264;
	m_EliteStandard.slope_uphill_coeff = 0.061129666198461545;
	m_EliteStandard.slope_downhill_coeff = 0.039091770601674;
	m_EliteStandard.swimming_base_power = 22.539443944820988;
	m_EliteStandard.swimming_encumbrance_threshold = 24.861681966829188;
	m_EliteStandard.swimming_static_drain_multiplier = 2.8846600339303228;
	m_EliteStandard.swimming_dynamic_power_efficiency = 2.148375479689191;
	m_EliteStandard.swimming_energy_to_stamina_coeff = 4.6630663955767752e-05;
	m_EliteStandard.env_heat_stress_max_multiplier = 1.4783260005188683;
	m_EliteStandard.env_rain_weight_max = 7.4600805778576955;
	m_EliteStandard.env_wind_resistance_coeff = 0.04768760922469151;
	m_EliteStandard.env_mud_penalty_max = 0.34958346415176084;
	m_EliteStandard.env_temperature_heat_penalty_coeff = 0.015458592336727844;
	m_EliteStandard.env_temperature_cold_recovery_penalty_coeff = 0.05259418358158886;
}
...
protected void InitStandardMilsimDefaults(bool shouldInit)
{
	...
	m_StandardMilsim.energy_to_stamina_coeff = 3.0265337969563792e-05;
	m_StandardMilsim.base_recovery_rate = 4.4755025160347033e-04;
	m_StandardMilsim.standing_recovery_multiplier = 1.984527950344009;
	m_StandardMilsim.prone_recovery_multiplier = 2.529993266742613;
	m_StandardMilsim.load_recovery_penalty_coeff = 1.2006273832912313e-04;
	m_StandardMilsim.load_recovery_penalty_exponent = 1.3335257117395856;
	m_StandardMilsim.encumbrance_speed_penalty_coeff = 0.10028944410419988;
	m_StandardMilsim.encumbrance_stamina_drain_coeff = 0.8069247935515617;
	m_StandardMilsim.sprint_stamina_drain_multiplier = 4.804898004656696;
	m_StandardMilsim.fatigue_accumulation_coeff = 0.017554979422976742;
	m_StandardMilsim.fatigue_max_factor = 2.8803239788032786;
	m_StandardMilsim.aerobic_efficiency_factor = 0.8838456647116071;
	m_StandardMilsim.anaerobic_efficiency_factor = 1.2221211277123643;
	m_StandardMilsim.recovery_nonlinear_coeff = 0.687124541288223;
	m_StandardMilsim.fast_recovery_multiplier = 3.4883146663592117;
	m_StandardMilsim.medium_recovery_multiplier = 2.146451090799627;
	m_StandardMilsim.slow_recovery_multiplier = 0.9362987179176496;
	m_StandardMilsim.marginal_decay_threshold = 0.8880920387112783;
	m_StandardMilsim.marginal_decay_coeff = 1.124693478760589;
	m_StandardMilsim.min_recovery_stamina_threshold = 0.23669460143678803;
	m_StandardMilsim.min_recovery_rest_time_seconds = 4.936146099497652;
	m_StandardMilsim.sprint_speed_boost = 0.3042754588389501;
	m_StandardMilsim.posture_crouch_multiplier = 0.516143363699651;
	m_StandardMilsim.posture_prone_multiplier = 0.4596346682324443;
	m_StandardMilsim.jump_stamina_base_cost = 0.025979384857862026;
	m_StandardMilsim.vault_stamina_start_cost = 0.019170280672000665;
	m_StandardMilsim.climb_stamina_tick_cost = 0.01024601461296585;
	m_StandardMilsim.jump_consecutive_penalty = 0.4029657908719264;
	m_StandardMilsim.slope_uphill_coeff = 0.061129666198461545;
	m_StandardMilsim.slope_downhill_coeff = 0.039091770601674;
	m_StandardMilsim.swimming_base_power = 22.539443944820988;
	m_StandardMilsim.swimming_encumbrance_threshold = 24.861681966829188;
	m_StandardMilsim.swimming_static_drain_multiplier = 2.8846600339303228;
	m_StandardMilsim.swimming_dynamic_power_efficiency = 2.148375479689191;
	m_StandardMilsim.swimming_energy_to_stamina_coeff = 4.6630663955767752e-05;
	m_StandardMilsim.env_heat_stress_max_multiplier = 1.4783260005188683;
	m_StandardMilsim.env_rain_weight_max = 7.4600805778576955;
	m_StandardMilsim.env_wind_resistance_coeff = 0.04768760922469151;
	m_StandardMilsim.env_mud_penalty_max = 0.34958346415176084;
	m_StandardMilsim.env_temperature_heat_penalty_coeff = 0.015458592336727844;
	m_StandardMilsim.env_temperature_cold_recovery_penalty_coeff = 0.05259418358158886;
}
...
protected void InitTacticalActionDefaults(bool shouldInit)
{
	...
	m_TacticalAction.energy_to_stamina_coeff = 3.0265337969563792e-05;
	m_TacticalAction.base_recovery_rate = 4.4755025160347033e-04;
	m_TacticalAction.standing_recovery_multiplier = 1.984527950344009;
	m_TacticalAction.prone_recovery_multiplier = 2.529993266742613;
	m_TacticalAction.load_recovery_penalty_coeff = 1.2006273832912313e-04;
	m_TacticalAction.load_recovery_penalty_exponent = 1.3335257117395856;
	m_TacticalAction.encumbrance_speed_penalty_coeff = 0.10028944410419988;
	m_TacticalAction.encumbrance_stamina_drain_coeff = 0.8069247935515617;
	m_TacticalAction.sprint_stamina_drain_multiplier = 4.804898004656696;
	m_TacticalAction.fatigue_accumulation_coeff = 0.017554979422976742;
	m_TacticalAction.fatigue_max_factor = 2.8803239788032786;
	m_TacticalAction.aerobic_efficiency_factor = 0.8838456647116071;
	m_TacticalAction.anaerobic_efficiency_factor = 1.2221211277123643;
	m_TacticalAction.recovery_nonlinear_coeff = 0.687124541288223;
	m_TacticalAction.fast_recovery_multiplier = 3.4883146663592117;
	m_TacticalAction.medium_recovery_multiplier = 2.146451090799627;
	m_TacticalAction.slow_recovery_multiplier = 0.9362987179176496;
	m_TacticalAction.marginal_decay_threshold = 0.8880920387112783;
	m_TacticalAction.marginal_decay_coeff = 1.124693478760589;
	m_TacticalAction.min_recovery_stamina_threshold = 0.23669460143678803;
	m_TacticalAction.min_recovery_rest_time_seconds = 4.936146099497652;
	m_TacticalAction.sprint_speed_boost = 0.3042754588389501;
	m_TacticalAction.posture_crouch_multiplier = 0.516143363699651;
	m_TacticalAction.posture_prone_multiplier = 0.4596346682324443;
	m_TacticalAction.jump_stamina_base_cost = 0.025979384857862026;
	m_TacticalAction.vault_stamina_start_cost = 0.019170280672000665;
	m_TacticalAction.climb_stamina_tick_cost = 0.01024601461296585;
	m_TacticalAction.jump_consecutive_penalty = 0.4029657908719264;
	m_TacticalAction.slope_uphill_coeff = 0.061129666198461545;
	m_TacticalAction.slope_downhill_coeff = 0.039091770601674;
	m_TacticalAction.swimming_base_power = 22.539443944820988;
	m_TacticalAction.swimming_encumbrance_threshold = 24.861681966829188;
	m_TacticalAction.swimming_static_drain_multiplier = 2.8846600339303228;
	m_TacticalAction.swimming_dynamic_power_efficiency = 2.148375479689191;
	m_TacticalAction.swimming_energy_to_stamina_coeff = 4.6630663955767752e-05;
	m_TacticalAction.env_heat_stress_max_multiplier = 1.4783260005188683;
	m_TacticalAction.env_rain_weight_max = 7.4600805778576955;
	m_TacticalAction.env_wind_resistance_coeff = 0.04768760922469151;
	m_TacticalAction.env_mud_penalty_max = 0.34958346415176084;
	m_TacticalAction.env_temperature_heat_penalty_coeff = 0.015458592336727844;
	m_TacticalAction.env_temperature_cold_recovery_penalty_coeff = 0.05259418358158886;
}
