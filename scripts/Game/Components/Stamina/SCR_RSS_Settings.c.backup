...
protected void InitEliteStandardDefaults(bool shouldInit)
{
	...
	m_EliteStandard.energy_to_stamina_coeff = 2.5241358053606185e-05;
	m_EliteStandard.base_recovery_rate = 4.9689099160352655e-04;
	m_EliteStandard.standing_recovery_multiplier = 1.9778014149887746;
	m_EliteStandard.prone_recovery_multiplier = 2.542883884499604;
	m_EliteStandard.load_recovery_penalty_coeff = 1.3636432292355116e-04;
	m_EliteStandard.load_recovery_penalty_exponent = 1.2832887220953717;
	m_EliteStandard.encumbrance_speed_penalty_coeff = 0.26101839289256934;
	m_EliteStandard.encumbrance_stamina_drain_coeff = 0.8919037094053623;
	m_EliteStandard.sprint_stamina_drain_multiplier = 2.648255506735372;
	m_EliteStandard.fatigue_accumulation_coeff = 0.008769337989059725;
	m_EliteStandard.fatigue_max_factor = 2.1081562944532317;
	m_EliteStandard.aerobic_efficiency_factor = 0.8169608397924872;
	m_EliteStandard.anaerobic_efficiency_factor = 1.0509616889540234;
	m_EliteStandard.recovery_nonlinear_coeff = 0.6561638068877313;
	m_EliteStandard.fast_recovery_multiplier = 3.493395502024244;
	m_EliteStandard.medium_recovery_multiplier = 2.2445604678600986;
	m_EliteStandard.slow_recovery_multiplier = 0.6178904037646737;
	m_EliteStandard.marginal_decay_threshold = 0.8528706772872855;
	m_EliteStandard.marginal_decay_coeff = 1.0659181859728895;
	m_EliteStandard.min_recovery_stamina_threshold = 0.19646643927465418;
	m_EliteStandard.min_recovery_rest_time_seconds = 3.054507945512143;
	m_EliteStandard.sprint_speed_boost = 0.29304172111862;
	m_EliteStandard.posture_crouch_multiplier = 0.9146168340599409;
	m_EliteStandard.posture_prone_multiplier = 0.5178691826499364;
	m_EliteStandard.jump_stamina_base_cost = 0.0374473983754781;
	m_EliteStandard.vault_stamina_start_cost = 0.021993839804720007;
	m_EliteStandard.climb_stamina_tick_cost = 0.008356649318450827;
	m_EliteStandard.jump_consecutive_penalty = 0.4890605092418058;
	m_EliteStandard.slope_uphill_coeff = 0.0873730469130207;
	m_EliteStandard.slope_downhill_coeff = 0.02722389263398631;
	m_EliteStandard.swimming_base_power = 16.25889434060029;
	m_EliteStandard.swimming_encumbrance_threshold = 29.26719422802332;
	m_EliteStandard.swimming_static_drain_multiplier = 2.9551223487054665;
	m_EliteStandard.swimming_dynamic_power_efficiency = 2.088314459513704;
	m_EliteStandard.swimming_energy_to_stamina_coeff = 5.5683577048006128e-05;
	m_EliteStandard.env_heat_stress_max_multiplier = 1.5254109832730822;
	m_EliteStandard.env_rain_weight_max = 6.694770665946427;
	m_EliteStandard.env_wind_resistance_coeff = 0.031337318974153136;
	m_EliteStandard.env_mud_penalty_max = 0.3714799730053424;
	m_EliteStandard.env_temperature_heat_penalty_coeff = 0.016636713329178952;
	m_EliteStandard.env_temperature_cold_recovery_penalty_coeff = 0.042815054706695575;
}
...
protected void InitStandardMilsimDefaults(bool shouldInit)
{
	...
	m_StandardMilsim.energy_to_stamina_coeff = 2.5145155601007001e-05;
	m_StandardMilsim.base_recovery_rate = 4.9689099160352655e-04;
	m_StandardMilsim.standing_recovery_multiplier = 1.9667061400184607;
	m_StandardMilsim.prone_recovery_multiplier = 1.8849821996310498;
	m_StandardMilsim.load_recovery_penalty_coeff = 1.2723834048041359e-04;
	m_StandardMilsim.load_recovery_penalty_exponent = 1.2079127603764994;
	m_StandardMilsim.encumbrance_speed_penalty_coeff = 0.1623359099044948;
	m_StandardMilsim.encumbrance_stamina_drain_coeff = 0.8776262375106189;
	m_StandardMilsim.sprint_stamina_drain_multiplier = 2.5271560292428337;
	m_StandardMilsim.fatigue_accumulation_coeff = 0.015262612547841036;
	m_StandardMilsim.fatigue_max_factor = 1.7262290453690514;
	m_StandardMilsim.aerobic_efficiency_factor = 0.8339762012101472;
	m_StandardMilsim.anaerobic_efficiency_factor = 1.0848929906616371;
	m_StandardMilsim.recovery_nonlinear_coeff = 0.6673744141213667;
	m_StandardMilsim.fast_recovery_multiplier = 3.4921485704914144;
	m_StandardMilsim.medium_recovery_multiplier = 1.7968173896555744;
	m_StandardMilsim.slow_recovery_multiplier = 0.938511866313589;
	m_StandardMilsim.marginal_decay_threshold = 0.7351667400528059;
	m_StandardMilsim.marginal_decay_coeff = 1.1019405505996493;
	m_StandardMilsim.min_recovery_stamina_threshold = 0.21026022080217824;
	m_StandardMilsim.min_recovery_rest_time_seconds = 2.70097531755906;
	m_StandardMilsim.sprint_speed_boost = 0.32200165481296666;
	m_StandardMilsim.posture_crouch_multiplier = 0.6658200356165922;
	m_StandardMilsim.posture_prone_multiplier = 0.43401254810855655;
	m_StandardMilsim.jump_stamina_base_cost = 0.032606771465515015;
	m_StandardMilsim.vault_stamina_start_cost = 0.020762855192405547;
	m_StandardMilsim.climb_stamina_tick_cost = 0.010854929023803531;
	m_StandardMilsim.jump_consecutive_penalty = 0.5594198361978392;
	m_StandardMilsim.slope_uphill_coeff = 0.08693058457318562;
	m_StandardMilsim.slope_downhill_coeff = 0.02063583466063558;
	m_StandardMilsim.swimming_base_power = 18.979398857971347;
	m_StandardMilsim.swimming_encumbrance_threshold = 26.106290401586225;
	m_StandardMilsim.swimming_static_drain_multiplier = 3.3770062650056687;
	m_StandardMilsim.swimming_dynamic_power_efficiency = 1.7146541030993725;
	m_StandardMilsim.swimming_energy_to_stamina_coeff = 4.6450930027735601e-05;
	m_StandardMilsim.env_heat_stress_max_multiplier = 1.4555402842734708;
	m_StandardMilsim.env_rain_weight_max = 9.22614095762141;
	m_StandardMilsim.env_wind_resistance_coeff = 0.042487042853624334;
	m_StandardMilsim.env_mud_penalty_max = 0.41759684090405935;
	m_StandardMilsim.env_temperature_heat_penalty_coeff = 0.015908578683045262;
	m_StandardMilsim.env_temperature_cold_recovery_penalty_coeff = 0.05130021498622862;
}
...
protected void InitTacticalActionDefaults(bool shouldInit)
{
	...
	m_TacticalAction.energy_to_stamina_coeff = 2.5241358053606185e-05;
	m_TacticalAction.base_recovery_rate = 4.9689099160352655e-04;
	m_TacticalAction.standing_recovery_multiplier = 1.9667061400184607;
	m_TacticalAction.prone_recovery_multiplier = 1.8484634529243826;
	m_TacticalAction.load_recovery_penalty_coeff = 1.0522012757210167e-04;
	m_TacticalAction.load_recovery_penalty_exponent = 1.4829929705137357;
	m_TacticalAction.encumbrance_speed_penalty_coeff = 0.23570235473349532;
	m_TacticalAction.encumbrance_stamina_drain_coeff = 0.8232928409775595;
	m_TacticalAction.sprint_stamina_drain_multiplier = 3.9085534411664096;
	m_TacticalAction.fatigue_accumulation_coeff = 0.02576043860307977;
	m_TacticalAction.fatigue_max_factor = 1.9422901683450757;
	m_TacticalAction.aerobic_efficiency_factor = 0.8177325990501637;
	m_TacticalAction.anaerobic_efficiency_factor = 1.4821713166891666;
	m_TacticalAction.recovery_nonlinear_coeff = 0.6561638068877313;
	m_TacticalAction.fast_recovery_multiplier = 3.493395502024244;
	m_TacticalAction.medium_recovery_multiplier = 2.331028311487189;
	m_TacticalAction.slow_recovery_multiplier = 0.8851146789149318;
	m_TacticalAction.marginal_decay_threshold = 0.8464881852808044;
	m_TacticalAction.marginal_decay_coeff = 1.10612858005413;
	m_TacticalAction.min_recovery_stamina_threshold = 0.18286372680777369;
	m_TacticalAction.min_recovery_rest_time_seconds = 2.2836146692330592;
	m_TacticalAction.sprint_speed_boost = 0.26219569649174346;
	m_TacticalAction.posture_crouch_multiplier = 0.7955019980504139;
	m_TacticalAction.posture_prone_multiplier = 0.7643377759190777;
	m_TacticalAction.jump_stamina_base_cost = 0.03250183844036436;
	m_TacticalAction.vault_stamina_start_cost = 0.023784141511391493;
	m_TacticalAction.climb_stamina_tick_cost = 0.011742914179067119;
	m_TacticalAction.jump_consecutive_penalty = 0.4262004263000324;
	m_TacticalAction.slope_uphill_coeff = 0.08137455917897606;
	m_TacticalAction.slope_downhill_coeff = 0.027897964966823133;
	m_TacticalAction.swimming_base_power = 16.722918952161784;
	m_TacticalAction.swimming_encumbrance_threshold = 27.477041522008886;
	m_TacticalAction.swimming_static_drain_multiplier = 2.6277011968331525;
	m_TacticalAction.swimming_dynamic_power_efficiency = 2.4465831262936124;
	m_TacticalAction.swimming_energy_to_stamina_coeff = 4.5458472358759811e-05;
	m_TacticalAction.env_heat_stress_max_multiplier = 1.4858416586734653;
	m_TacticalAction.env_rain_weight_max = 9.559581031074261;
	m_TacticalAction.env_wind_resistance_coeff = 0.05042719796657297;
	m_TacticalAction.env_mud_penalty_max = 0.475410884684064;
	m_TacticalAction.env_temperature_heat_penalty_coeff = 0.020611018538577133;
	m_TacticalAction.env_temperature_cold_recovery_penalty_coeff = 0.05534928486326215;
}
