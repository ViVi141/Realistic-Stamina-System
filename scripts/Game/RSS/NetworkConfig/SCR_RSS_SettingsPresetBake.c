    ...
    static void InitEliteStandardDefaults(SCR_RSS_Settings s, bool shouldInit)
{
	...
	// metrics: ease=0.8556 recovery=0.000933 realism=2.3697
	s.m_EliteStandard.energy_to_stamina_coeff = 1.7003544020614371e-07;
	s.m_EliteStandard.base_recovery_rate = 8.5759188329240227e-05;
	s.m_EliteStandard.standing_recovery_multiplier = 0.854895669847669;
	s.m_EliteStandard.prone_recovery_multiplier = 1.5652373741328292;
	s.m_EliteStandard.load_recovery_penalty_coeff = 2.8567991170375513e-04;
	s.m_EliteStandard.load_recovery_penalty_exponent = 2.0;
	s.m_EliteStandard.encumbrance_speed_penalty_coeff = 0.34831175355474137;
	s.m_EliteStandard.encumbrance_speed_penalty_exponent = 1.5;
	s.m_EliteStandard.encumbrance_speed_penalty_max = 0.75;
	s.m_EliteStandard.encumbrance_stamina_drain_coeff = 2.73911190256559;
	s.m_EliteStandard.load_metabolic_dampening = 0.70;
	s.m_EliteStandard.max_recovery_per_tick = 2.4368811823493217e-04;
	...
	s.m_EliteStandard.recovery_nonlinear_coeff = 0.32549079356777233;
	s.m_EliteStandard.fast_recovery_multiplier = 1.31715996584833;
	s.m_EliteStandard.medium_recovery_multiplier = 1.0572892473499016;
	s.m_EliteStandard.slow_recovery_multiplier = 0.4739704089370412;
	...
	s.m_EliteStandard.sprint_speed_boost = 0.2520098335775642;
	s.m_EliteStandard.sprint_velocity_threshold = 5.5;
	s.m_EliteStandard.posture_crouch_multiplier = 3.366546531465748;
	s.m_EliteStandard.posture_prone_multiplier = 3.4165415864787496;
	...
	s.m_EliteStandard.crouching_recovery_multiplier = 1.360324720643294;
	s.m_EliteStandard.willpower_threshold = 0.3188921125234195;
	s.m_EliteStandard.sprint_enable_threshold = 0.2585833562875179;
	ApplyV6TierCpDefaults(s.m_EliteStandard, 0);
	s.m_EliteStandard.critical_power_watts = 889.7423428072453;
	s.m_EliteStandard.sprint_power_cap_watts = 2355.083028477993;
	s.m_EliteStandard.v5_run_speed_ms = 3.05;
	s.m_EliteStandard.v5_sprint_speed_ms = 4.5;
	s.m_EliteStandard.v5_walk_speed_ms = 1.4;
	s.m_EliteStandard.w_prime_max_joules = 2.1322461770206111e+04;
	s.m_EliteStandard.w_prime_recovery_w_per_s = 10.000122312613987;
}
    ...
    static void InitStandardMilsimDefaults(SCR_RSS_Settings s, bool shouldInit)
{
	...
	// 战斗/恢复折中 → 拟真与可玩性平衡
	// metrics: ease=0.8436 recovery=0.001244 realism=3.4146
	s.m_StandardMilsim.energy_to_stamina_coeff = 1.1172941814256477e-07;
	s.m_StandardMilsim.base_recovery_rate = 9.5780580627960704e-05;
	s.m_StandardMilsim.standing_recovery_multiplier = 0.8589401073382247;
	s.m_StandardMilsim.prone_recovery_multiplier = 1.852929261381568;
	s.m_StandardMilsim.load_recovery_penalty_coeff = 2.1976018156283055e-04;
	s.m_StandardMilsim.load_recovery_penalty_exponent = 2.0;
	s.m_StandardMilsim.encumbrance_speed_penalty_coeff = 0.33802690754866876;
	s.m_StandardMilsim.encumbrance_speed_penalty_exponent = 1.5;
	s.m_StandardMilsim.encumbrance_speed_penalty_max = 0.75;
	s.m_StandardMilsim.encumbrance_stamina_drain_coeff = 2.4458134791701607;
	s.m_StandardMilsim.load_metabolic_dampening = 0.70;
	s.m_StandardMilsim.max_recovery_per_tick = 4.1020099798751202e-04;
	...
	s.m_StandardMilsim.recovery_nonlinear_coeff = 0.4969406671445007;
	s.m_StandardMilsim.fast_recovery_multiplier = 1.3184376584451185;
	s.m_StandardMilsim.medium_recovery_multiplier = 1.0744616481426463;
	s.m_StandardMilsim.slow_recovery_multiplier = 0.3687274192939788;
	...
	s.m_StandardMilsim.sprint_speed_boost = 0.2068307361888445;
	s.m_StandardMilsim.sprint_velocity_threshold = 5.5;
	s.m_StandardMilsim.posture_crouch_multiplier = 2.985290872534736;
	s.m_StandardMilsim.posture_prone_multiplier = 4.020453498459;
	...
	s.m_StandardMilsim.crouching_recovery_multiplier = 1.4641786623265431;
	s.m_StandardMilsim.willpower_threshold = 0.39982069649495444;
	s.m_StandardMilsim.sprint_enable_threshold = 0.1962606280978974;
	ApplyV6TierCpDefaults(s.m_StandardMilsim, 1);
	s.m_StandardMilsim.critical_power_watts = 1010.8096641164578;
	s.m_StandardMilsim.sprint_power_cap_watts = 2724.366342690539;
	s.m_StandardMilsim.v5_run_speed_ms = 3.2;
	s.m_StandardMilsim.v5_sprint_speed_ms = 4.5;
	s.m_StandardMilsim.v5_walk_speed_ms = 1.4;
	s.m_StandardMilsim.w_prime_max_joules = 3.1038412425252551e+04;
	s.m_StandardMilsim.w_prime_recovery_w_per_s = 11.864686232913344;
}
    ...
    static void InitTacticalActionDefaults(SCR_RSS_Settings s, bool shouldInit)
{
	...
	// metrics: ease=0.8367 recovery=0.001254 realism=4.4745
	s.m_TacticalAction.energy_to_stamina_coeff = 1.0563968484130718e-07;
	s.m_TacticalAction.base_recovery_rate = 1.2975623986935674e-04;
	s.m_TacticalAction.standing_recovery_multiplier = 0.861666196509375;
	s.m_TacticalAction.prone_recovery_multiplier = 2.1573773587211926;
	s.m_TacticalAction.load_recovery_penalty_coeff = 1.3171089755485325e-04;
	s.m_TacticalAction.load_recovery_penalty_exponent = 2.0;
	s.m_TacticalAction.encumbrance_speed_penalty_coeff = 0.29044000839903483;
	s.m_TacticalAction.encumbrance_speed_penalty_exponent = 1.5;
	s.m_TacticalAction.encumbrance_speed_penalty_max = 0.75;
	s.m_TacticalAction.encumbrance_stamina_drain_coeff = 2.3207644848727975;
	s.m_TacticalAction.load_metabolic_dampening = 0.70;
	s.m_TacticalAction.max_recovery_per_tick = 4.1118770930414041e-04;
	...
	s.m_TacticalAction.recovery_nonlinear_coeff = 0.3176701299352142;
	s.m_TacticalAction.fast_recovery_multiplier = 1.3998840922532407;
	s.m_TacticalAction.medium_recovery_multiplier = 1.1338427901769312;
	s.m_TacticalAction.slow_recovery_multiplier = 0.41443684197620806;
	...
	s.m_TacticalAction.sprint_speed_boost = 0.1988501198875789;
	s.m_TacticalAction.sprint_velocity_threshold = 5.5;
	s.m_TacticalAction.posture_crouch_multiplier = 2.872128853671083;
	s.m_TacticalAction.posture_prone_multiplier = 3.0020084672025047;
	...
	s.m_TacticalAction.crouching_recovery_multiplier = 1.6593602916858317;
	s.m_TacticalAction.willpower_threshold = 0.3968870654634508;
	s.m_TacticalAction.sprint_enable_threshold = 0.21021897040587617;
	ApplyV6TierCpDefaults(s.m_TacticalAction, 2);
	s.m_TacticalAction.critical_power_watts = 1029.7976821582808;
	s.m_TacticalAction.sprint_power_cap_watts = 2747.591757170903;
	s.m_TacticalAction.v5_run_speed_ms = 3.4;
	s.m_TacticalAction.v5_sprint_speed_ms = 4.5;
	s.m_TacticalAction.v5_walk_speed_ms = 1.4;
	s.m_TacticalAction.w_prime_max_joules = 3.1654659677079271e+04;
	s.m_TacticalAction.w_prime_recovery_w_per_s = 14.279824961620161;
}
    ...
    static void ApplyV6TierCpDefaults(SCR_RSS_Params p, int tier)
    {
        ...
        if (tier == 0)
        {
            p.critical_power_watts = 889.7423428072453;
            p.w_prime_max_joules = 2.1322461770206111e+04;
            p.w_prime_recovery_w_per_s = 10.000122312613987;
            p.sprint_power_cap_watts = 2355.083028477993;
            p.v5_walk_speed_ms = 1.4;
        ...
        {
            p.critical_power_watts = 1010.8096641164578;
            p.w_prime_max_joules = 3.1038412425252551e+04;
            p.w_prime_recovery_w_per_s = 11.864686232913344;
            p.sprint_power_cap_watts = 2724.366342690539;
            p.v5_walk_speed_ms = 1.4;
        ...
        {
            p.critical_power_watts = 1029.7976821582808;
            p.w_prime_max_joules = 3.1654659677079271e+04;
            p.w_prime_recovery_w_per_s = 14.279824961620161;
            p.sprint_power_cap_watts = 2747.591757170903;
            p.v5_walk_speed_ms = 1.4;
